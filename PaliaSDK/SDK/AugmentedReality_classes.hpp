...
static_assert(sizeof(AARActor) == 0x0002A0, "Wrong size on AARActor");
...
public:
	...
	static bool AddTrackedPointWithName(struct FTransform& WorldTransform, const class FString& PointName, bool bDeletePointsWithSameName);
	static void CalculateAlignmentTransform(struct FTransform& TransformInFirstCoordinateSystem, struct FTransform& TransformInSecondCoordinateSystem, struct FTransform* AlignmentTransform);
	...
	static bool GetObjectClassificationAtLocation(struct FVector& InWorldLocation, EARObjectClassification* OutClassification, struct FVector* OutClassificationLocation, float MaxLocationDiff);
	...
	static struct FIntPoint ResizeXRCamera(struct FIntPoint& InSize);
...
public:
	...
	static struct FTransform GetLocalTransform(struct FARTraceResult& TraceResult);
...
{
public:
	uint8                                         Pad_3647[0x20];                                    // 0x0030(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3648[0x10];                                    // 0x0070(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailed;                                          // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_3649[0x40];                                    // 0x0070(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_364A[0x30];                                    // 0x02B0(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_364B[0x7];                                     // 0x02E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_364C[0x18];                                    // 0x0308(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UARComponent) == 0x000320, "Wrong size on UARComponent");
static_assert(offsetof(UARComponent, NativeID) == 0x0002A0, "Member 'UARComponent::NativeID' has a wrong offset!");
static_assert(offsetof(UARComponent, bUseDefaultReplication) == 0x0002E0, "Member 'UARComponent::bUseDefaultReplication' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultMeshMaterial) == 0x0002E8, "Member 'UARComponent::DefaultMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultWireframeMeshMaterial) == 0x0002F0, "Member 'UARComponent::DefaultWireframeMeshMaterial' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_364D[0xF];                                     // 0x0321(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_364E[0x5];                                     // 0x0323(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_364F[0x28];                                    // 0x0388(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UARFaceComponent) == 0x0003B0, "Wrong size on UARFaceComponent");
static_assert(offsetof(UARFaceComponent, TransformSetting) == 0x000320, "Member 'UARFaceComponent::TransformSetting' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bUpdateVertexNormal) == 0x000321, "Member 'UARFaceComponent::bUpdateVertexNormal' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bFaceOutOfScreen) == 0x000322, "Member 'UARFaceComponent::bFaceOutOfScreen' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, ReplicatedPayload) == 0x000328, "Member 'UARFaceComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARImageComponent) == 0x0003C0, "Wrong size on UARImageComponent");
static_assert(offsetof(UARImageComponent, ReplicatedPayload) == 0x000320, "Member 'UARImageComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UAREnvironmentProbeComponent) == 0x000380, "Wrong size on UAREnvironmentProbeComponent");
static_assert(offsetof(UAREnvironmentProbeComponent, ReplicatedPayload) == 0x000320, "Member 'UAREnvironmentProbeComponent::ReplicatedPayload' has a wrong offset!");
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailed;                                          // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_3656[0x30];                                    // 0x0070(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailed;                                          // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_3658[0x38];                                    // 0x0070(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UGetGeoLocationAsyncTaskBlueprintProxy* GetGeoLocationAtWorldPosition(class UObject* WorldContextObject, struct FVector& WorldPosition);
...
{
public:
	FMulticastInlineDelegateProperty_             OnARActorSpawnedDelegate;                          // 0x02A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnARActorToBeDestroyedDelegate;                    // 0x02B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_365A[0x10];                                    // 0x02C0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AAROriginActor) == 0x0002A0, "Wrong size on AAROriginActor");
...
public:
	...
	uint8                                         Pad_365B[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_365C[0x1F];                                    // 0x0101(0x001F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_365D[0x10];                                    // 0x0140(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_365E[0x2];                                     // 0x0046(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_365F[0x3];                                     // 0x005D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3660[0x1];                                     // 0x008F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3661[0x4];                                     // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3662[0x6];                                     // 0x00AA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	int32                                         BufferSizePerChunk;                                // 0x0388(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3663[0x64];                                    // 0x038C(0x0064)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AARSharedWorldGameMode) == 0x0003F0, "Wrong size on AARSharedWorldGameMode");
static_assert(offsetof(AARSharedWorldGameMode, BufferSizePerChunk) == 0x000388, "Member 'AARSharedWorldGameMode::BufferSizePerChunk' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3664[0x8];                                     // 0x0340(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AARSharedWorldGameState) == 0x000348, "Wrong size on AARSharedWorldGameState");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageData) == 0x000310, "Member 'AARSharedWorldGameState::PreviewImageData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldData) == 0x000320, "Member 'AARSharedWorldGameState::ARWorldData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesTotal) == 0x000330, "Member 'AARSharedWorldGameState::PreviewImageBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesTotal) == 0x000334, "Member 'AARSharedWorldGameState::ARWorldBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesDelivered) == 0x000338, "Member 'AARSharedWorldGameState::PreviewImageBytesDelivered' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesDelivered) == 0x00033C, "Member 'AARSharedWorldGameState::ARWorldBytesDelivered' has a wrong offset!");
...
{
public:
	uint8                                         Pad_3665[0x8];                                     // 0x0860(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AARSharedWorldPlayerController) == 0x000868, "Wrong size on AARSharedWorldPlayerController");
...
{
public:
	class UAREnvironmentCaptureProbe*             CaptureProbe;                                      // 0x02B0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3668[0x8];                                     // 0x02B8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AARSkyLight) == 0x0002C0, "Wrong size on AARSkyLight");
static_assert(offsetof(AARSkyLight, CaptureProbe) == 0x0002B0, "Member 'AARSkyLight::CaptureProbe' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3669[0x3];                                     // 0x01F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_366A[0x5];                                     // 0x021B(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_366B[0x3];                                     // 0x0291(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_366C[0x8];                                     // 0x02B8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_366D[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_366E[0xF];                                     // 0x0101(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_366F[0x16];                                    // 0x011A(0x0016)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3670[0xC];                                     // 0x0134(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3671[0x10];                                    // 0x0148(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3672[0x7];                                     // 0x0159(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3673[0x8];                                     // 0x01A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3674[0xC];                                     // 0x0184(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3675[0x7];                                     // 0x0171(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<EARFaceBlendShape, float>                BlendShapes;                                       // 0x0178(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_3676[0x38];                                    // 0x01C8(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_367A[0x8];                                     // 0x0178(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_367B[0x8];                                     // 0x01A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	bool GetObjectClassificationAtLocation(struct FVector& InWorldLocation, EARObjectClassification* OutClassification, struct FVector* OutClassificationLocation, float MaxLocationDiff);
...
{
public:
	uint8                                         Pad_367E[0x18];                                    // 0x0158(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	FMulticastInlineDelegateProperty_             OnAddTrackedGeometry;                              // 0x00A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedGeometry;                           // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedGeometry;                           // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedPlane;                                 // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedPlane;                              // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedPlane;                              // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedPoint;                                 // 0x0100(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedPoint;                              // 0x0110(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedPoint;                              // 0x0120(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedImage;                                 // 0x0130(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedImage;                              // 0x0140(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedImage;                              // 0x0150(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedFace;                                  // 0x0160(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedFace;                               // 0x0170(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedFace;                               // 0x0180(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedEnvProbe;                              // 0x0190(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedEnvProbe;                           // 0x01A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedEnvProbe;                           // 0x01B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnAddTrackedObject;                                // 0x01C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUpdateTrackedObject;                             // 0x01D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnRemoveTrackedObject;                             // 0x01E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UARTrackableNotifyComponent) == 0x0001F0, "Wrong size on UARTrackableNotifyComponent");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedGeometry) == 0x0000A0, "Member 'UARTrackableNotifyComponent::OnAddTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedGeometry) == 0x0000B0, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedGeometry) == 0x0000C0, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedPlane) == 0x0000D0, "Member 'UARTrackableNotifyComponent::OnAddTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedPlane) == 0x0000E0, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedPlane) == 0x0000F0, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedPoint) == 0x000100, "Member 'UARTrackableNotifyComponent::OnAddTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedPoint) == 0x000110, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedPoint) == 0x000120, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedImage) == 0x000130, "Member 'UARTrackableNotifyComponent::OnAddTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedImage) == 0x000140, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedImage) == 0x000150, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedFace) == 0x000160, "Member 'UARTrackableNotifyComponent::OnAddTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedFace) == 0x000170, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedFace) == 0x000180, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedEnvProbe) == 0x000190, "Member 'UARTrackableNotifyComponent::OnAddTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedEnvProbe) == 0x0001A0, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedEnvProbe) == 0x0001B0, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedEnvProbe' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_367F[0x7];                                     // 0x0051(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
