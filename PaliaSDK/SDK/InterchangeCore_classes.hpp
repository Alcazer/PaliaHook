...
public:
	...
	uint8                                         Pad_3936[0x18];                                    // 0x0038(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3938[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3939[0x60];                                    // 0x0088(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool DoesPropertyStatesExist(class FName PropertyPath) const;
...
{
public:
	uint8                                         Pad_393F[0x28];                                    // 0x0028(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3940[0x38];                                    // 0x0028(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void InitializeNode(const class FString& UniqueID, const class FString& DisplayLabel, EInterchangeNodeContainerType NodeContainerType);
...
public:
	...
	uint8                                         Pad_3958[0x50];                                    // 0x0078(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetNodes(class UClass* ClassNode, TArray<class FString>* OutNodes) const;
...
{
public:
	uint8                                         Pad_395D[0xE0];                                    // 0x0060(0x00E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetFactoryDependency(int32 Param_Index, class FString* OutDependency) const;
...
{
public:
	uint8                                         Pad_3965[0x70];                                    // 0x0060(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
