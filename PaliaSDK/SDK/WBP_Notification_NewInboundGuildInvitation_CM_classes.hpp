...
public:
	...
	class UWBP_Template_Button_Primary_01_CM_C*   Button_Primary_Accept;                             // 0x04E8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 Image_99;                                          // 0x04F0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_TextBlock_Styled*                TextBlock_Message;                                 // 0x04F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Template_Button_Secondary_01_CM_C* WBP_Template_Button_Secondary_01_CM_C_0;           // 0x0500(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Template_Notification_Major_C*     WBP_Template_Major;                                // 0x0508(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FGuid                                  PlayerGuildId;                                     // 0x0510(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	struct FUniqueNetIdRepl                       InviterId;                                         // 0x0520(0x0030)(Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	class UVALUI_NotificationQueue*               NotificationQueue;                                 // 0x0550(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  NotificationId;                                    // 0x0558(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         NotificationDuration;                              // 0x0568(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Notification_NewInboundGuildInvitation_CM_C) == 0x000570, "Wrong size on UWBP_Notification_NewInboundGuildInvitation_CM_C");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, UberGraphFrame) == 0x0004E0, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, Button_Primary_Accept) == 0x0004E8, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::Button_Primary_Accept' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, Image_99) == 0x0004F0, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::Image_99' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, TextBlock_Message) == 0x0004F8, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::TextBlock_Message' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, WBP_Template_Button_Secondary_01_CM_C_0) == 0x000500, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::WBP_Template_Button_Secondary_01_CM_C_0' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, WBP_Template_Major) == 0x000508, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::WBP_Template_Major' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, PlayerGuildId) == 0x000510, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::PlayerGuildId' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, InviterId) == 0x000520, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::InviterId' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, NotificationQueue) == 0x000550, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::NotificationQueue' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, NotificationId) == 0x000558, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::NotificationId' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_NewInboundGuildInvitation_CM_C, NotificationDuration) == 0x000568, "Member 'UWBP_Notification_NewInboundGuildInvitation_CM_C::NotificationDuration' has a wrong offset!");
