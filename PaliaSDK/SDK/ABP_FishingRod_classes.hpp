...
// 0x1000 (0x1350 - 0x0350)
class UABP_FishingRod_C final  : public UAnimInstance
{
public:
	uint8                                         Pad_3DF2[0x8];                                     // 0x0348(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FAnimNode_Inertialization              AnimGraphNode_Inertialization;                     // 0x1210(0x0100)()
	struct FAnimNode_Root                         AnimGraphNode_Root;                                // 0x1310(0x0020)()
	double                                        FishingDirection;                                  // 0x1330(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        StateLerp;                                         // 0x1338(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          ReelingHeld;                                       // 0x1340(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsBiting;                                          // 0x1341(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFishingMiniGameState                         MinigameState;                                     // 0x1342(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFishingMiniGameResult                        EndState;                                          // 0x1343(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           AnimStateTransition;                               // 0x1344(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UABP_FishingRod_C) == 0x001350, "Wrong size on UABP_FishingRod_C");
...
static_assert(offsetof(UABP_FishingRod_C, AnimGraphNode_Root) == 0x001310, "Member 'UABP_FishingRod_C::AnimGraphNode_Root' has a wrong offset!");
static_assert(offsetof(UABP_FishingRod_C, FishingDirection) == 0x001330, "Member 'UABP_FishingRod_C::FishingDirection' has a wrong offset!");
static_assert(offsetof(UABP_FishingRod_C, StateLerp) == 0x001338, "Member 'UABP_FishingRod_C::StateLerp' has a wrong offset!");
static_assert(offsetof(UABP_FishingRod_C, ReelingHeld) == 0x001340, "Member 'UABP_FishingRod_C::ReelingHeld' has a wrong offset!");
static_assert(offsetof(UABP_FishingRod_C, IsBiting) == 0x001341, "Member 'UABP_FishingRod_C::IsBiting' has a wrong offset!");
static_assert(offsetof(UABP_FishingRod_C, MinigameState) == 0x001342, "Member 'UABP_FishingRod_C::MinigameState' has a wrong offset!");
static_assert(offsetof(UABP_FishingRod_C, EndState) == 0x001343, "Member 'UABP_FishingRod_C::EndState' has a wrong offset!");
static_assert(offsetof(UABP_FishingRod_C, AnimStateTransition) == 0x001344, "Member 'UABP_FishingRod_C::AnimStateTransition' has a wrong offset!");
