...
bool IGameplayTagAssetInterface::HasAllMatchingGameplayTags(struct FGameplayTagContainer& TagContainer) const
{
	static class UFunction* Func = nullptr;
...
bool IGameplayTagAssetInterface::HasAnyMatchingGameplayTags(struct FGameplayTagContainer& TagContainer) const
{
	static class UFunction* Func = nullptr;
