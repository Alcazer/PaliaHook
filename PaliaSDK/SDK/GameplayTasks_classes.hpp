...
{
public:
	uint8                                         Pad_100B[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_100C[0x2];                                     // 0x0038(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_100D[0x25];                                    // 0x003B(0x0025)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1012[0x14];                                    // 0x00A0(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_4A : 1;                                     // 0x00B4(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bIsNetDirty : 1;                                   // 0x00B4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1013[0x3];                                     // 0x00B5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1014[0x10];                                    // 0x00C8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UGameplayTasksComponent, TaskPriorityQueue) == 0x0000B8, "Member 'UGameplayTasksComponent::TaskPriorityQueue' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, TickingTasks) == 0x0000D8, "Member 'UGameplayTasksComponent::TickingTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, KnownTasks) == 0x0000E8, "Member 'UGameplayTasksComponent::KnownTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, OnClaimedResourcesChange) == 0x0000F8, "Member 'UGameplayTasksComponent::OnClaimedResourcesChange' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, SimulatedTasks) == 0x000108, "Member 'UGameplayTasksComponent::SimulatedTasks' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1017[0x3];                                     // 0x002D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1018[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1019[0x30];                                    // 0x0088(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_101C[0x10];                                    // 0x0088(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_101D[0x8];                                     // 0x0078(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
