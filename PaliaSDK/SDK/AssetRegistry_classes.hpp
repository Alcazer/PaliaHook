...
public:
	...
	bool GetAssets(struct FARFilter& Filter, TArray<struct FAssetData>* OutAssetData, bool bSkipARFilteredAssets) const;
	...
	void GetDerivedClassNames(TArray<struct FTopLevelAssetPath>& ClassNames, TSet<struct FTopLevelAssetPath>& ExcludedClassNames, TSet<struct FTopLevelAssetPath>* OutDerivedClassNames) const;
...
{
public:
	uint8                                         Pad_1295[0xD50];                                   // 0x0028(0x0D50)(Fixing Struct Size After Last Property [ Dumper-7 ])
