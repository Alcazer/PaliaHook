...
public:
	...
	uint8                                         Pad_4337[0x6];                                     // 0x0022(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4338[0x7];                                     // 0x0099(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4339[0x3];                                     // 0x00B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class UObject* Loaded)>        K2Node_CreateDelegate_OutputDelegate;              // 0x00B4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_433A[0x4];                                     // 0x00C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLauncherConfig                        CallFunc_GetLauncherConfig_ReturnValue;            // 0x00C8(0x0060)()
	bool                                          CallFunc_IsLauncher_ReturnValue;                   // 0x0128(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_IsVisible;                            // 0x0129(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_433B[0x6];                                     // 0x012A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming) == 0x000140, "Wrong size on WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming");
...
static_assert(offsetof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming, K2Node_SwitchEnum_CmpSuccess) == 0x000098, "Member 'WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming, CallFunc_LoadAsset_Blocking_ReturnValue) == 0x0000A0, "Member 'WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming::CallFunc_LoadAsset_Blocking_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming, K2Node_DynamicCast_AsItem_Type_Definition) == 0x0000A8, "Member 'WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming::K2Node_DynamicCast_AsItem_Type_Definition' has a wrong offset!");
static_assert(offsetof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming, K2Node_DynamicCast_bSuccess_1) == 0x0000B0, "Member 'WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming, K2Node_CreateDelegate_OutputDelegate) == 0x0000B4, "Member 'WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming, CallFunc_GetLauncherConfig_ReturnValue) == 0x0000C8, "Member 'WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming::CallFunc_GetLauncherConfig_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming, CallFunc_IsLauncher_ReturnValue) == 0x000128, "Member 'WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming::CallFunc_IsLauncher_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming, K2Node_Event_IsVisible) == 0x000129, "Member 'WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming::K2Node_Event_IsVisible' has a wrong offset!");
static_assert(offsetof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming, K2Node_CustomEvent_Loaded) == 0x000130, "Member 'WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming::K2Node_CustomEvent_Loaded' has a wrong offset!");
static_assert(offsetof(WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming, CallFunc_IsValidSoftObjectReference_ReturnValue) == 0x000138, "Member 'WBP_Aiming_C_ExecuteUbergraph_WBP_Aiming::CallFunc_IsValidSoftObjectReference_ReturnValue' has a wrong offset!");
