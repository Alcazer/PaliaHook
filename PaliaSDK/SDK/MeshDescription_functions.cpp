...
void UMeshDescriptionBase::GetEdgeVertices(struct FEdgeID& EdgeID, TArray<struct FVertexID>* OutVertexIDs) const
{
	static class UFunction* Func = nullptr;
...
bool UMeshDescriptionBase::IsTriangleValid(struct FTriangleID& TriangleID) const
{
	static class UFunction* Func = nullptr;
