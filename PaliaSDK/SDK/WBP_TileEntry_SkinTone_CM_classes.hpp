...
static_assert(sizeof(UWBP_TileEntry_SkinTone_CM_C) == 0x000288, "Wrong size on UWBP_TileEntry_SkinTone_CM_C");
static_assert(offsetof(UWBP_TileEntry_SkinTone_CM_C, UberGraphFrame) == 0x000278, "Member 'UWBP_TileEntry_SkinTone_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_TileEntry_SkinTone_CM_C, WBP_Button_ColorPicker_CM) == 0x000280, "Member 'UWBP_TileEntry_SkinTone_CM_C::WBP_Button_ColorPicker_CM' has a wrong offset!");
