...
public:
	...
	uint8                                         Pad_3574[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x0008(0x0040)(IsPlainOldData, NoDestructor)
	float                                         K2Node_Event_InDeltaTime;                          // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_Timer_C_ExecuteUbergraph_WBP_Timer) == 0x000008, "Wrong alignment on WBP_Timer_C_ExecuteUbergraph_WBP_Timer");
static_assert(sizeof(WBP_Timer_C_ExecuteUbergraph_WBP_Timer) == 0x000050, "Wrong size on WBP_Timer_C_ExecuteUbergraph_WBP_Timer");
...
static_assert(offsetof(WBP_Timer_C_ExecuteUbergraph_WBP_Timer, K2Node_Event_MyGeometry) == 0x000008, "Member 'WBP_Timer_C_ExecuteUbergraph_WBP_Timer::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(WBP_Timer_C_ExecuteUbergraph_WBP_Timer, K2Node_Event_InDeltaTime) == 0x000048, "Member 'WBP_Timer_C_ExecuteUbergraph_WBP_Timer::K2Node_Event_InDeltaTime' has a wrong offset!");
...
static_assert(alignof(WBP_Timer_C_Tick) == 0x000008, "Wrong alignment on WBP_Timer_C_Tick");
static_assert(sizeof(WBP_Timer_C_Tick) == 0x000048, "Wrong size on WBP_Timer_C_Tick");
static_assert(offsetof(WBP_Timer_C_Tick, MyGeometry) == 0x000000, "Member 'WBP_Timer_C_Tick::MyGeometry' has a wrong offset!");
static_assert(offsetof(WBP_Timer_C_Tick, InDeltaTime) == 0x000040, "Member 'WBP_Timer_C_Tick::InDeltaTime' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3575[0x6];                                     // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
