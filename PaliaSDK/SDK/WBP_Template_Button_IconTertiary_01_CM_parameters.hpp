...
public:
	...
	uint8                                         Pad_4741[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_Template_Button_IconTertiary_01_CM_C_OnFocusReceived) == 0x0001B8, "Wrong size on WBP_Template_Button_IconTertiary_01_CM_C_OnFocusReceived");
...
static_assert(offsetof(WBP_Template_Button_IconTertiary_01_CM_C_OnFocusReceived, InFocusEvent) == 0x000040, "Member 'WBP_Template_Button_IconTertiary_01_CM_C_OnFocusReceived::InFocusEvent' has a wrong offset!");
static_assert(offsetof(WBP_Template_Button_IconTertiary_01_CM_C_OnFocusReceived, ReturnValue) == 0x000048, "Member 'WBP_Template_Button_IconTertiary_01_CM_C_OnFocusReceived::ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Template_Button_IconTertiary_01_CM_C_OnFocusReceived, CallFunc_Handled_ReturnValue) == 0x000100, "Member 'WBP_Template_Button_IconTertiary_01_CM_C_OnFocusReceived::CallFunc_Handled_ReturnValue' has a wrong offset!");
