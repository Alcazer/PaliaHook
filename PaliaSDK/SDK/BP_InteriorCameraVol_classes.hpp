...
public:
	...
	class USpringArmComponent*                    CameraBoom;                                        // 0x02B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                           Timer;                                             // 0x02B8(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class UCameraComponent*                       FollowCamera;                                      // 0x02C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_InteriorCameraVol_C) == 0x0002C8, "Wrong size on ABP_InteriorCameraVol_C");
static_assert(offsetof(ABP_InteriorCameraVol_C, UberGraphFrame) == 0x0002A0, "Member 'ABP_InteriorCameraVol_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_InteriorCameraVol_C, Box) == 0x0002A8, "Member 'ABP_InteriorCameraVol_C::Box' has a wrong offset!");
static_assert(offsetof(ABP_InteriorCameraVol_C, CameraBoom) == 0x0002B0, "Member 'ABP_InteriorCameraVol_C::CameraBoom' has a wrong offset!");
static_assert(offsetof(ABP_InteriorCameraVol_C, Timer) == 0x0002B8, "Member 'ABP_InteriorCameraVol_C::Timer' has a wrong offset!");
static_assert(offsetof(ABP_InteriorCameraVol_C, FollowCamera) == 0x0002C0, "Member 'ABP_InteriorCameraVol_C::FollowCamera' has a wrong offset!");
