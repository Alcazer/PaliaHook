...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_VillagerPlateWidgetComponent_C;  // 0x0958(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UBP_VillagerPlateWidgetComponent_C) == 0x000960, "Wrong size on UBP_VillagerPlateWidgetComponent_C");
static_assert(offsetof(UBP_VillagerPlateWidgetComponent_C, UberGraphFrame_BP_VillagerPlateWidgetComponent_C) == 0x000958, "Member 'UBP_VillagerPlateWidgetComponent_C::UberGraphFrame_BP_VillagerPlateWidgetComponent_C' has a wrong offset!");
