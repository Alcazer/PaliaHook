...
{
public:
	uint8                                         Pad_32D2[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	class ALobbyBeaconState*                      ParentState;                                       // 0x0118(0x0008)(ZeroConstructor, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
