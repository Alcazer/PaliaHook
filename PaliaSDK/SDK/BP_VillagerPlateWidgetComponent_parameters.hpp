...
public:
	...
	struct FVillagerActionInfo                    K2Node_CustomEvent_actionInfo;                     // 0x0010(0x0080)()
	class UWBP_VillagerPlate_C*                   K2Node_DynamicCast_AsWBP_Villager_Plate;           // 0x0090(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_VillagerPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerPlateWidgetComponent) == 0x0000A0, "Wrong size on BP_VillagerPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerPlateWidgetComponent");
...
static_assert(offsetof(BP_VillagerPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerPlateWidgetComponent, K2Node_DynamicCast_AsWBP_Villager_Plate) == 0x000090, "Member 'BP_VillagerPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerPlateWidgetComponent::K2Node_DynamicCast_AsWBP_Villager_Plate' has a wrong offset!");
static_assert(offsetof(BP_VillagerPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerPlateWidgetComponent, K2Node_DynamicCast_bSuccess) == 0x000098, "Member 'BP_VillagerPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerPlateWidgetComponent::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_VillagerPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerPlateWidgetComponent, CallFunc_TextIsEmpty_ReturnValue) == 0x000099, "Member 'BP_VillagerPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerPlateWidgetComponent::CallFunc_TextIsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_VillagerPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerPlateWidgetComponent, CallFunc_Not_PreBool_ReturnValue) == 0x00009A, "Member 'BP_VillagerPlateWidgetComponent_C_ExecuteUbergraph_BP_VillagerPlateWidgetComponent::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
{
public:
	struct FVillagerActionInfo                    ActionInfo;                                        // 0x0000(0x0080)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
static_assert(sizeof(BP_VillagerPlateWidgetComponent_C_SetCurrentActionForWidgetComp) == 0x000080, "Wrong size on BP_VillagerPlateWidgetComponent_C_SetCurrentActionForWidgetComp");
