...
public:
	...
	uint8                                         Pad_45C8[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x0008(0x0040)(IsPlainOldData, NoDestructor)
	float                                         K2Node_Event_InDeltaTime;                          // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_45C9[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_GetCameraYaw_Rotation;                    // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_PlayerFacingIndicator_C_ExecuteUbergraph_WBP_PlayerFacingIndicator) == 0x000060, "Wrong size on WBP_PlayerFacingIndicator_C_ExecuteUbergraph_WBP_PlayerFacingIndicator");
...
static_assert(offsetof(WBP_PlayerFacingIndicator_C_ExecuteUbergraph_WBP_PlayerFacingIndicator, K2Node_Event_MyGeometry) == 0x000008, "Member 'WBP_PlayerFacingIndicator_C_ExecuteUbergraph_WBP_PlayerFacingIndicator::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(WBP_PlayerFacingIndicator_C_ExecuteUbergraph_WBP_PlayerFacingIndicator, K2Node_Event_InDeltaTime) == 0x000048, "Member 'WBP_PlayerFacingIndicator_C_ExecuteUbergraph_WBP_PlayerFacingIndicator::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(WBP_PlayerFacingIndicator_C_ExecuteUbergraph_WBP_PlayerFacingIndicator, CallFunc_GetCameraYaw_Rotation) == 0x000050, "Member 'WBP_PlayerFacingIndicator_C_ExecuteUbergraph_WBP_PlayerFacingIndicator::CallFunc_GetCameraYaw_Rotation' has a wrong offset!");
static_assert(offsetof(WBP_PlayerFacingIndicator_C_ExecuteUbergraph_WBP_PlayerFacingIndicator, CallFunc_SetRenderTransformAngle_Angle_ImplicitCast) == 0x000058, "Member 'WBP_PlayerFacingIndicator_C_ExecuteUbergraph_WBP_PlayerFacingIndicator::CallFunc_SetRenderTransformAngle_Angle_ImplicitCast' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_45CA[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45CB[0x4];                                     // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(WBP_PlayerFacingIndicator_C_Tick) == 0x000008, "Wrong alignment on WBP_PlayerFacingIndicator_C_Tick");
static_assert(sizeof(WBP_PlayerFacingIndicator_C_Tick) == 0x000048, "Wrong size on WBP_PlayerFacingIndicator_C_Tick");
...
static_assert(offsetof(WBP_PlayerFacingIndicator_C_Tick, InDeltaTime) == 0x000040, "Member 'WBP_PlayerFacingIndicator_C_Tick::InDeltaTime' has a wrong offset!");
