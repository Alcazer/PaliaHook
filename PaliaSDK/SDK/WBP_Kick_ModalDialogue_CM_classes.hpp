...
public:
	...
	class UWBP_Template_PopupSecondary_02_CM_C*   KickPopup;                                         // 0x0560(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Template_PopupSecondary_02_CM_C*   UnkickPopup;                                       // 0x0568(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Kick_ModalDialogue_CM_C) == 0x0005D0, "Wrong size on UWBP_Kick_ModalDialogue_CM_C");
static_assert(offsetof(UWBP_Kick_ModalDialogue_CM_C, UberGraphFrame) == 0x000558, "Member 'UWBP_Kick_ModalDialogue_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Kick_ModalDialogue_CM_C, KickPopup) == 0x000560, "Member 'UWBP_Kick_ModalDialogue_CM_C::KickPopup' has a wrong offset!");
static_assert(offsetof(UWBP_Kick_ModalDialogue_CM_C, UnkickPopup) == 0x000568, "Member 'UWBP_Kick_ModalDialogue_CM_C::UnkickPopup' has a wrong offset!");
static_assert(offsetof(UWBP_Kick_ModalDialogue_CM_C, WBP_PlayerCharacterRow_Permission_CM_KIck) == 0x000570, "Member 'UWBP_Kick_ModalDialogue_CM_C::WBP_PlayerCharacterRow_Permission_CM_KIck' has a wrong offset!");
static_assert(offsetof(UWBP_Kick_ModalDialogue_CM_C, WBP_PlayerCharacterRow_Permission_CM_UnKick) == 0x000578, "Member 'UWBP_Kick_ModalDialogue_CM_C::WBP_PlayerCharacterRow_Permission_CM_UnKick' has a wrong offset!");
static_assert(offsetof(UWBP_Kick_ModalDialogue_CM_C, WidgetSwitcherKickMode) == 0x000580, "Member 'UWBP_Kick_ModalDialogue_CM_C::WidgetSwitcherKickMode' has a wrong offset!");
static_assert(offsetof(UWBP_Kick_ModalDialogue_CM_C, TargetUserId) == 0x000588, "Member 'UWBP_Kick_ModalDialogue_CM_C::TargetUserId' has a wrong offset!");
static_assert(offsetof(UWBP_Kick_ModalDialogue_CM_C, BlockErrorSent) == 0x0005B8, "Member 'UWBP_Kick_ModalDialogue_CM_C::BlockErrorSent' has a wrong offset!");
static_assert(offsetof(UWBP_Kick_ModalDialogue_CM_C, Kick) == 0x0005C8, "Member 'UWBP_Kick_ModalDialogue_CM_C::Kick' has a wrong offset!");
