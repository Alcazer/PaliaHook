...
public:
	...
	uint8                                         Pad_434F[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UVAL_ItemTypeDefinitionAsset> ItemType;                                          // 0x0030(0x0030)(Edit, BlueprintVisible, BlueprintReadOnly, ExposeOnSpawn, HasGetValueTypeHash)
	bool                                          IsRequestable;                                     // 0x0060(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(sizeof(UListItem_RequestableItemType_C) == 0x000068, "Wrong size on UListItem_RequestableItemType_C");
...
static_assert(offsetof(UListItem_RequestableItemType_C, IsRequestable) == 0x000060, "Member 'UListItem_RequestableItemType_C::IsRequestable' has a wrong offset!");
