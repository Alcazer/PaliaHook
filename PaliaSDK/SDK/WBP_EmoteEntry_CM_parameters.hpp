...
public:
	...
	uint8                                         Pad_4413[0x6];                                     // 0x000A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4414[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4415[0x7];                                     // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4416[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4417[0x3];                                     // 0x005D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4418[0x7];                                     // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4419[0x7];                                     // 0x0079(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPointerEvent                          K2Node_Event_PointerEvent;                         // 0x0080(0x0098)(ConstParm)
	class UDragDropOperation*                     K2Node_Event_Operation;                            // 0x0118(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x0120(0x0040)(IsPlainOldData, NoDestructor)
	struct FPointerEvent                          K2Node_Event_MouseEvent_1;                         // 0x0160(0x0098)(ConstParm)
	struct FPointerEvent                          K2Node_Event_MouseEvent;                           // 0x01F8(0x0098)(ConstParm)
...
static_assert(sizeof(WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM) == 0x000298, "Wrong size on WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM");
...
static_assert(offsetof(WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM, K2Node_Event_Operation) == 0x000118, "Member 'WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM::K2Node_Event_Operation' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM, K2Node_Event_MyGeometry) == 0x000120, "Member 'WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM, K2Node_Event_MouseEvent_1) == 0x000160, "Member 'WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM::K2Node_Event_MouseEvent_1' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM, K2Node_Event_MouseEvent) == 0x0001F8, "Member 'WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM::K2Node_Event_MouseEvent' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM, K2Node_Select_Default) == 0x000290, "Member 'WBP_EmoteEntry_CM_C_ExecuteUbergraph_WBP_EmoteEntry_CM::K2Node_Select_Default' has a wrong offset!");
...
static_assert(sizeof(WBP_EmoteEntry_CM_C_OnDragCancelled) == 0x0000A0, "Wrong size on WBP_EmoteEntry_CM_C_OnDragCancelled");
...
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDragCancelled, Operation) == 0x000098, "Member 'WBP_EmoteEntry_CM_C_OnDragCancelled::Operation' has a wrong offset!");
...
public:
	...
	class UBP_EmoteDrag_C*                        CallFunc_CreateDragDropOperation_ReturnValue;      // 0x00E0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UWBP_EmoteDrag_C*                       CallFunc_Create_ReturnValue;                       // 0x00E8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TSoftObjectPtr<class UTexture2D>              CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue; // 0x00F0(0x0030)(UObjectWrapper, HasGetValueTypeHash)
};
static_assert(alignof(WBP_EmoteEntry_CM_C_OnDragDetected) == 0x000008, "Wrong alignment on WBP_EmoteEntry_CM_C_OnDragDetected");
static_assert(sizeof(WBP_EmoteEntry_CM_C_OnDragDetected) == 0x000120, "Wrong size on WBP_EmoteEntry_CM_C_OnDragDetected");
...
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDragDetected, PointerEvent) == 0x000040, "Member 'WBP_EmoteEntry_CM_C_OnDragDetected::PointerEvent' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDragDetected, Operation) == 0x0000D8, "Member 'WBP_EmoteEntry_CM_C_OnDragDetected::Operation' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDragDetected, CallFunc_CreateDragDropOperation_ReturnValue) == 0x0000E0, "Member 'WBP_EmoteEntry_CM_C_OnDragDetected::CallFunc_CreateDragDropOperation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDragDetected, CallFunc_Create_ReturnValue) == 0x0000E8, "Member 'WBP_EmoteEntry_CM_C_OnDragDetected::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDragDetected, CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue) == 0x0000F0, "Member 'WBP_EmoteEntry_CM_C_OnDragDetected::CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_441A[0x7];                                     // 0x00E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UBP_EmoteDrag_C*                        K2Node_DynamicCast_AsBP_Emote_Drag;                // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x00F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_441B[0x7];                                     // 0x00F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_EmoteWheelChoice_CM_C*             K2Node_DynamicCast_AsWBP_Emote_Wheel_Choice_CM;    // 0x00F8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_EmoteEntry_CM_C_OnDrop) == 0x000108, "Wrong size on WBP_EmoteEntry_CM_C_OnDrop");
...
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDrop, PointerEvent) == 0x000040, "Member 'WBP_EmoteEntry_CM_C_OnDrop::PointerEvent' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDrop, Operation) == 0x0000D8, "Member 'WBP_EmoteEntry_CM_C_OnDrop::Operation' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDrop, ReturnValue) == 0x0000E0, "Member 'WBP_EmoteEntry_CM_C_OnDrop::ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDrop, K2Node_DynamicCast_AsBP_Emote_Drag) == 0x0000E8, "Member 'WBP_EmoteEntry_CM_C_OnDrop::K2Node_DynamicCast_AsBP_Emote_Drag' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDrop, K2Node_DynamicCast_bSuccess) == 0x0000F0, "Member 'WBP_EmoteEntry_CM_C_OnDrop::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDrop, K2Node_DynamicCast_AsWBP_Emote_Wheel_Choice_CM) == 0x0000F8, "Member 'WBP_EmoteEntry_CM_C_OnDrop::K2Node_DynamicCast_AsWBP_Emote_Wheel_Choice_CM' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnDrop, K2Node_DynamicCast_bSuccess_1) == 0x000100, "Member 'WBP_EmoteEntry_CM_C_OnDrop::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
...
static_assert(sizeof(WBP_EmoteEntry_CM_C_OnFocusReceived) == 0x0001B8, "Wrong size on WBP_EmoteEntry_CM_C_OnFocusReceived");
...
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnFocusReceived, InFocusEvent) == 0x000040, "Member 'WBP_EmoteEntry_CM_C_OnFocusReceived::InFocusEvent' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnFocusReceived, ReturnValue) == 0x000048, "Member 'WBP_EmoteEntry_CM_C_OnFocusReceived::ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnFocusReceived, CallFunc_Handled_ReturnValue) == 0x000100, "Member 'WBP_EmoteEntry_CM_C_OnFocusReceived::CallFunc_Handled_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_EmoteEntry_CM_C_OnMouseButtonDown) == 0x000248, "Wrong size on WBP_EmoteEntry_CM_C_OnMouseButtonDown");
...
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnMouseButtonDown, MouseEvent) == 0x000040, "Member 'WBP_EmoteEntry_CM_C_OnMouseButtonDown::MouseEvent' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnMouseButtonDown, ReturnValue) == 0x0000D8, "Member 'WBP_EmoteEntry_CM_C_OnMouseButtonDown::ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnMouseButtonDown, CallFunc_DetectDragIfPressed_ReturnValue) == 0x000190, "Member 'WBP_EmoteEntry_CM_C_OnMouseButtonDown::CallFunc_DetectDragIfPressed_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_EmoteEntry_CM_C_OnMouseEnter) == 0x0000D8, "Wrong size on WBP_EmoteEntry_CM_C_OnMouseEnter");
...
static_assert(offsetof(WBP_EmoteEntry_CM_C_OnMouseEnter, MouseEvent) == 0x000040, "Member 'WBP_EmoteEntry_CM_C_OnMouseEnter::MouseEvent' has a wrong offset!");
...
static_assert(sizeof(WBP_EmoteEntry_CM_C_OnMouseLeave) == 0x000098, "Wrong size on WBP_EmoteEntry_CM_C_OnMouseLeave");
...
public:
	...
	uint8                                         Pad_441C[0x6];                                     // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
