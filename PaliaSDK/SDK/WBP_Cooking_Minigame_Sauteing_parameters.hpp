...
public:
	...
	bool                                          CallFunc_IsPaused_ReturnValue;                     // 0x004C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsPlaying_ReturnValue;                    // 0x004F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsButtonHeld_ReturnValue;                 // 0x0052(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4799[0x5];                                     // 0x0053(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UWidget*                                K2Node_Select_Default;                             // 0x0058(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetTargetPosition_ReturnValue;            // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_479A[0x4];                                     // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	float                                         CallFunc_NormalizeDegrees_ReturnValue;             // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsButtonHeld_ReturnValue_1;               // 0x0074(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_479B[0x2];                                     // 0x0076(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	float                                         CallFunc_NormalizeDegrees_degrees_ImplicitCast;    // 0x0090(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing) == 0x000098, "Wrong size on WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing");
...
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, K2Node_Event_MyGeometry) == 0x000008, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, K2Node_Event_InDeltaTime) == 0x000048, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_IsPaused_ReturnValue) == 0x00004C, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_IsPaused_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_Not_PreBool_ReturnValue) == 0x00004D, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_IsValid_ReturnValue) == 0x00004E, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_IsPlaying_ReturnValue) == 0x00004F, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_IsPlaying_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_BooleanAND_ReturnValue) == 0x000050, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, Temp_bool_Variable) == 0x000051, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_IsButtonHeld_ReturnValue) == 0x000052, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_IsButtonHeld_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, K2Node_Select_Default) == 0x000058, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_GetTargetPosition_ReturnValue) == 0x000060, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_GetTargetPosition_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000068, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_NormalizeDegrees_ReturnValue) == 0x000070, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_NormalizeDegrees_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_IsButtonHeld_ReturnValue_1) == 0x000074, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_IsButtonHeld_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_NotEqual_BoolBool_ReturnValue) == 0x000075, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_NotEqual_BoolBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_PlayAnimationForward_ReturnValue) == 0x000078, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_PlayAnimationForward_ReturnValue_1) == 0x000080, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_PlayAnimationForward_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x000088, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing, CallFunc_NormalizeDegrees_degrees_ImplicitCast) == 0x000090, "Member 'WBP_Cooking_Minigame_Sauteing_C_ExecuteUbergraph_WBP_Cooking_Minigame_Sauteing::CallFunc_NormalizeDegrees_degrees_ImplicitCast' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_479C[0x2];                                     // 0x000A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_479D[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_479E[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_479F[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47A0[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(WBP_Cooking_Minigame_Sauteing_C_Tick) == 0x000008, "Wrong alignment on WBP_Cooking_Minigame_Sauteing_C_Tick");
static_assert(sizeof(WBP_Cooking_Minigame_Sauteing_C_Tick) == 0x000048, "Wrong size on WBP_Cooking_Minigame_Sauteing_C_Tick");
...
static_assert(offsetof(WBP_Cooking_Minigame_Sauteing_C_Tick, InDeltaTime) == 0x000040, "Member 'WBP_Cooking_Minigame_Sauteing_C_Tick::InDeltaTime' has a wrong offset!");
