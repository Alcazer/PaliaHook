...
public:
	...
	uint8                                         Pad_2561[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2562[0x7];                                     // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FVariantDependency) == 0x000008, "Wrong alignment on FVariantDependency");
static_assert(sizeof(FVariantDependency) == 0x000068, "Wrong size on FVariantDependency");
static_assert(offsetof(FVariantDependency, VariantSet) == 0x000000, "Member 'FVariantDependency::VariantSet' has a wrong offset!");
static_assert(offsetof(FVariantDependency, Variant) == 0x000030, "Member 'FVariantDependency::Variant' has a wrong offset!");
static_assert(offsetof(FVariantDependency, bEnabled) == 0x000060, "Member 'FVariantDependency::bEnabled' has a wrong offset!");
