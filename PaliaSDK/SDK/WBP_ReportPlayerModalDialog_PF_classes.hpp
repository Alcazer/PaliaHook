...
public:
	...
	class UVALUI_MultiLineEditableTextBox_Styled* CommentText;                                       // 0x0530(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Template_Notification_Basic_Error_C* ErrorMessage;                                      // 0x0538(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_TextBlock_Styled*                TextBlock_Error;                                   // 0x0540(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_ComboBox_CM_C*                     WBP_ComboBox_CM;                                   // 0x0548(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UWBP_Template_PopupSecondary_02_CM_C*   WBP_Template_PopupSecondary_02_CM;                 // 0x0558(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FUniqueNetIdRepl                       TargetPlayerNetId;                                 // 0x0560(0x0030)(Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	ES6PLAT_PlayerBehaviorReportSource            Report_Source;                                     // 0x0590(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	ES6PLAT_PlayerBehaviorReportType              ReportType;                                        // 0x0591(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	uint8                                         Pad_4D5F[0x6];                                     // 0x0592(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, struct FS6PLAT_PlayerBehaviorReportCategoryInfo> CachedReportCategoryInfoMap;                       // 0x0598(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<class FText>                           DisplayNames;                                      // 0x05E8(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FValeriaChatMessage                    ReportedMessage;                                   // 0x05F8(0x0068)(Edit, BlueprintVisible, ExposeOnSpawn)
	struct FGuid                                  Character_Id;                                      // 0x0660(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         SurroundingMessageCount;                           // 0x0670(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4D60[0x4];                                     // 0x0674(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UClass*                                 Button_Style_Override;                             // 0x0678(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class UWidget*                                Parent_Widget;                                     // 0x0680(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWidget*                                Parent_Focused_Widget;                             // 0x0688(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_ReportPlayerModalDialog_PF_C) == 0x000690, "Wrong size on UWBP_ReportPlayerModalDialog_PF_C");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, UberGraphFrame) == 0x000528, "Member 'UWBP_ReportPlayerModalDialog_PF_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, CommentText) == 0x000530, "Member 'UWBP_ReportPlayerModalDialog_PF_C::CommentText' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, ErrorMessage) == 0x000538, "Member 'UWBP_ReportPlayerModalDialog_PF_C::ErrorMessage' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, TextBlock_Error) == 0x000540, "Member 'UWBP_ReportPlayerModalDialog_PF_C::TextBlock_Error' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, WBP_ComboBox_CM) == 0x000548, "Member 'UWBP_ReportPlayerModalDialog_PF_C::WBP_ComboBox_CM' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, WBP_CommonUIButtonPrompt) == 0x000550, "Member 'UWBP_ReportPlayerModalDialog_PF_C::WBP_CommonUIButtonPrompt' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, WBP_Template_PopupSecondary_02_CM) == 0x000558, "Member 'UWBP_ReportPlayerModalDialog_PF_C::WBP_Template_PopupSecondary_02_CM' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, TargetPlayerNetId) == 0x000560, "Member 'UWBP_ReportPlayerModalDialog_PF_C::TargetPlayerNetId' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, Report_Source) == 0x000590, "Member 'UWBP_ReportPlayerModalDialog_PF_C::Report_Source' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, ReportType) == 0x000591, "Member 'UWBP_ReportPlayerModalDialog_PF_C::ReportType' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, CachedReportCategoryInfoMap) == 0x000598, "Member 'UWBP_ReportPlayerModalDialog_PF_C::CachedReportCategoryInfoMap' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, DisplayNames) == 0x0005E8, "Member 'UWBP_ReportPlayerModalDialog_PF_C::DisplayNames' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, ReportedMessage) == 0x0005F8, "Member 'UWBP_ReportPlayerModalDialog_PF_C::ReportedMessage' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, Character_Id) == 0x000660, "Member 'UWBP_ReportPlayerModalDialog_PF_C::Character_Id' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, SurroundingMessageCount) == 0x000670, "Member 'UWBP_ReportPlayerModalDialog_PF_C::SurroundingMessageCount' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, Button_Style_Override) == 0x000678, "Member 'UWBP_ReportPlayerModalDialog_PF_C::Button_Style_Override' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, Parent_Widget) == 0x000680, "Member 'UWBP_ReportPlayerModalDialog_PF_C::Parent_Widget' has a wrong offset!");
static_assert(offsetof(UWBP_ReportPlayerModalDialog_PF_C, Parent_Focused_Widget) == 0x000688, "Member 'UWBP_ReportPlayerModalDialog_PF_C::Parent_Focused_Widget' has a wrong offset!");
