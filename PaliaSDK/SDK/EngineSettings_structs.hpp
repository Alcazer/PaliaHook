...
public:
	...
	uint8                                         Pad_11C2[0x8];                                     // 0x0020(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FTemplateMapInfoOverride) == 0x000058, "Wrong size on FTemplateMapInfoOverride");
