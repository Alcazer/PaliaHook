...
public:
	...
	class UVALUI_TextBlock_Styled*                TextBlock_ReportPrompt;                            // 0x0530(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Template_Popup_01_CM_C*            WBP_Template_Popup_01_CM;                          // 0x0538(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FUniqueNetIdRepl                       TargetUserId;                                      // 0x0540(0x0030)(Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             BlockErrorSent;                                    // 0x0570(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class FText                                   ReportConfirmationText;                            // 0x0580(0x0018)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(UWBP_Block_ModalDialogue_CM_C) == 0x000598, "Wrong size on UWBP_Block_ModalDialogue_CM_C");
static_assert(offsetof(UWBP_Block_ModalDialogue_CM_C, UberGraphFrame) == 0x000528, "Member 'UWBP_Block_ModalDialogue_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_CM_C, TextBlock_ReportPrompt) == 0x000530, "Member 'UWBP_Block_ModalDialogue_CM_C::TextBlock_ReportPrompt' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_CM_C, WBP_Template_Popup_01_CM) == 0x000538, "Member 'UWBP_Block_ModalDialogue_CM_C::WBP_Template_Popup_01_CM' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_CM_C, TargetUserId) == 0x000540, "Member 'UWBP_Block_ModalDialogue_CM_C::TargetUserId' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_CM_C, BlockErrorSent) == 0x000570, "Member 'UWBP_Block_ModalDialogue_CM_C::BlockErrorSent' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_CM_C, ReportConfirmationText) == 0x000580, "Member 'UWBP_Block_ModalDialogue_CM_C::ReportConfirmationText' has a wrong offset!");
