...
{
public:
	struct FValeriaItem                           Item;                                              // 0x00B8(0x0068)(Edit, BlueprintVisible, ExposeOnSpawn)
	EStoragePoolType                              StoragePool;                                       // 0x0120(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(sizeof(UBP_ItemDrag_Storage_C) == 0x000128, "Wrong size on UBP_ItemDrag_Storage_C");
static_assert(offsetof(UBP_ItemDrag_Storage_C, Item) == 0x0000B8, "Member 'UBP_ItemDrag_Storage_C::Item' has a wrong offset!");
static_assert(offsetof(UBP_ItemDrag_Storage_C, StoragePool) == 0x000120, "Member 'UBP_ItemDrag_Storage_C::StoragePool' has a wrong offset!");
