...
public:
	...
	class UWidgetAnimation*                       HoverAnim;                                         // 0x0280(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UWBP_EmoteSelectedTip_CM_C*             Emote_Selected_Tip;                                // 0x0288(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UImage*                                 Image_Tile_Default;                                // 0x0298(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 Image_Tile_Empty;                                  // 0x02A0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 Image_Tile_Hovered;                                // 0x02A8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 Image_Tile_Selected;                               // 0x02B0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWidgetSwitcher*                        Switcher_Tile;                                     // 0x02B8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_UButton_Styled*                  TileButton;                                        // 0x02C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	bool                                          bHovered;                                          // 0x02C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4C07[0x3];                                     // 0x02C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         EmoteIndex;                                        // 0x02CC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	struct FGuid                                  EmoteId;                                           // 0x02D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	class UWBP_EmoteDrag_C*                       DraggedWidget;                                     // 0x02E0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UObject*                                EmoteCollection;                                   // 0x02E8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4C08[0x7];                                     // 0x02F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEventReply                            NULLL;                                             // 0x02F8(0x00B8)(Edit, BlueprintVisible, DisableEditOnInstance)
	FMulticastInlineDelegateProperty_             OnEmoteWheelChoiceFocused;                         // 0x03B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class UWBP_EmoteCollection_Circular_C*        EmoteCircularCollection;                           // 0x03C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	float                                         Default_Render_Opacity;                            // 0x03C8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4C09[0x4];                                     // 0x03CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              DefaultTransform_Scale;                            // 0x03D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_EmoteWheelChoice_CM_C) == 0x0003E0, "Wrong size on UWBP_EmoteWheelChoice_CM_C");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, UberGraphFrame) == 0x000278, "Member 'UWBP_EmoteWheelChoice_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, HoverAnim) == 0x000280, "Member 'UWBP_EmoteWheelChoice_CM_C::HoverAnim' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, Emote_Selected_Tip) == 0x000288, "Member 'UWBP_EmoteWheelChoice_CM_C::Emote_Selected_Tip' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, Image_Icon) == 0x000290, "Member 'UWBP_EmoteWheelChoice_CM_C::Image_Icon' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, Image_Tile_Default) == 0x000298, "Member 'UWBP_EmoteWheelChoice_CM_C::Image_Tile_Default' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, Image_Tile_Empty) == 0x0002A0, "Member 'UWBP_EmoteWheelChoice_CM_C::Image_Tile_Empty' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, Image_Tile_Hovered) == 0x0002A8, "Member 'UWBP_EmoteWheelChoice_CM_C::Image_Tile_Hovered' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, Image_Tile_Selected) == 0x0002B0, "Member 'UWBP_EmoteWheelChoice_CM_C::Image_Tile_Selected' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, Switcher_Tile) == 0x0002B8, "Member 'UWBP_EmoteWheelChoice_CM_C::Switcher_Tile' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, TileButton) == 0x0002C0, "Member 'UWBP_EmoteWheelChoice_CM_C::TileButton' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, bHovered) == 0x0002C8, "Member 'UWBP_EmoteWheelChoice_CM_C::bHovered' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, EmoteIndex) == 0x0002CC, "Member 'UWBP_EmoteWheelChoice_CM_C::EmoteIndex' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, EmoteId) == 0x0002D0, "Member 'UWBP_EmoteWheelChoice_CM_C::EmoteId' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, DraggedWidget) == 0x0002E0, "Member 'UWBP_EmoteWheelChoice_CM_C::DraggedWidget' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, EmoteCollection) == 0x0002E8, "Member 'UWBP_EmoteWheelChoice_CM_C::EmoteCollection' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, IsSelected) == 0x0002F0, "Member 'UWBP_EmoteWheelChoice_CM_C::IsSelected' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, NULLL) == 0x0002F8, "Member 'UWBP_EmoteWheelChoice_CM_C::NULLL' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, OnEmoteWheelChoiceFocused) == 0x0003B0, "Member 'UWBP_EmoteWheelChoice_CM_C::OnEmoteWheelChoiceFocused' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, EmoteCircularCollection) == 0x0003C0, "Member 'UWBP_EmoteWheelChoice_CM_C::EmoteCircularCollection' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, Default_Render_Opacity) == 0x0003C8, "Member 'UWBP_EmoteWheelChoice_CM_C::Default_Render_Opacity' has a wrong offset!");
static_assert(offsetof(UWBP_EmoteWheelChoice_CM_C, DefaultTransform_Scale) == 0x0003D0, "Member 'UWBP_EmoteWheelChoice_CM_C::DefaultTransform_Scale' has a wrong offset!");
