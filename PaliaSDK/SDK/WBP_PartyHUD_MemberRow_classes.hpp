...
public:
	...
	class UImage*                                 Image_PartyLeader_Indicator;                       // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UNamedSlot*                             NamedSlot_UnderBar;                                // 0x0288(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UNamedSlot*                             NamedSlot_UnderName;                               // 0x0290(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_PlatformPlayerName_C*              WBP_PlatformPlayerName;                            // 0x0298(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FS6UI_ContextMenu                      PartyMemberContextMenu;                            // 0x02A0(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	struct FVAL_PartyMember                       PartyMember;                                       // 0x02C0(0x0050)(Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	class FText                                   Full_Name;                                         // 0x0310(0x0018)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UVALUI_TextBlockStyle*                  NameTextStyleOverride;                             // 0x0328(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_PartyHUD_MemberRow_C) == 0x000330, "Wrong size on UWBP_PartyHUD_MemberRow_C");
static_assert(offsetof(UWBP_PartyHUD_MemberRow_C, UberGraphFrame) == 0x000278, "Member 'UWBP_PartyHUD_MemberRow_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_PartyHUD_MemberRow_C, Image_PartyLeader_Indicator) == 0x000280, "Member 'UWBP_PartyHUD_MemberRow_C::Image_PartyLeader_Indicator' has a wrong offset!");
static_assert(offsetof(UWBP_PartyHUD_MemberRow_C, NamedSlot_UnderBar) == 0x000288, "Member 'UWBP_PartyHUD_MemberRow_C::NamedSlot_UnderBar' has a wrong offset!");
static_assert(offsetof(UWBP_PartyHUD_MemberRow_C, NamedSlot_UnderName) == 0x000290, "Member 'UWBP_PartyHUD_MemberRow_C::NamedSlot_UnderName' has a wrong offset!");
static_assert(offsetof(UWBP_PartyHUD_MemberRow_C, WBP_PlatformPlayerName) == 0x000298, "Member 'UWBP_PartyHUD_MemberRow_C::WBP_PlatformPlayerName' has a wrong offset!");
static_assert(offsetof(UWBP_PartyHUD_MemberRow_C, PartyMemberContextMenu) == 0x0002A0, "Member 'UWBP_PartyHUD_MemberRow_C::PartyMemberContextMenu' has a wrong offset!");
static_assert(offsetof(UWBP_PartyHUD_MemberRow_C, PartyMember) == 0x0002C0, "Member 'UWBP_PartyHUD_MemberRow_C::PartyMember' has a wrong offset!");
static_assert(offsetof(UWBP_PartyHUD_MemberRow_C, Full_Name) == 0x000310, "Member 'UWBP_PartyHUD_MemberRow_C::Full_Name' has a wrong offset!");
static_assert(offsetof(UWBP_PartyHUD_MemberRow_C, NameTextStyleOverride) == 0x000328, "Member 'UWBP_PartyHUD_MemberRow_C::NameTextStyleOverride' has a wrong offset!");
