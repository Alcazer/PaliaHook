...
public:
	...
	class UWBP_SettingsItem_Checkbox_CM_C*        Checkbox_EnableTips_CM;                            // 0x04E8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_ListView_Styled*                 ListView_FTUEFlags_01;                             // 0x04F0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	double                                        ScrollMoveSpeed;                                   // 0x04F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnFocusedItemChanged;                              // 0x0500(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(UWBP_FTUESettings_PF_C) == 0x000510, "Wrong size on UWBP_FTUESettings_PF_C");
static_assert(offsetof(UWBP_FTUESettings_PF_C, UberGraphFrame) == 0x0004E0, "Member 'UWBP_FTUESettings_PF_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_FTUESettings_PF_C, Checkbox_EnableTips_CM) == 0x0004E8, "Member 'UWBP_FTUESettings_PF_C::Checkbox_EnableTips_CM' has a wrong offset!");
static_assert(offsetof(UWBP_FTUESettings_PF_C, ListView_FTUEFlags_01) == 0x0004F0, "Member 'UWBP_FTUESettings_PF_C::ListView_FTUEFlags_01' has a wrong offset!");
static_assert(offsetof(UWBP_FTUESettings_PF_C, ScrollMoveSpeed) == 0x0004F8, "Member 'UWBP_FTUESettings_PF_C::ScrollMoveSpeed' has a wrong offset!");
static_assert(offsetof(UWBP_FTUESettings_PF_C, OnFocusedItemChanged) == 0x000500, "Member 'UWBP_FTUESettings_PF_C::OnFocusedItemChanged' has a wrong offset!");
