...
bool UARBlueprintLibrary::GetObjectClassificationAtLocation(struct FVector& InWorldLocation, EARObjectClassification* OutClassification, struct FVector* OutClassificationLocation, float MaxLocationDiff)
{
	static class UFunction* Func = nullptr;
...
void UARPin::DebugDraw(class UWorld* World, struct FLinearColor& Color, float Scale, float PersistForSeconds) const
{
	static class UFunction* Func = nullptr;
...
bool UARTrackedGeometry::HasSpatialMeshUsageFlag(EARSpatialMeshUsageFlags InFlag) const
{
	static class UFunction* Func = nullptr;
...
bool UARMeshGeometry::GetObjectClassificationAtLocation(struct FVector& InWorldLocation, EARObjectClassification* OutClassification, struct FVector* OutClassificationLocation, float MaxLocationDiff)
{
	static class UFunction* Func = nullptr;
