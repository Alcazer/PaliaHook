...
public:
	...
	uint8                                         Pad_4716[0x7];                                     // 0x0571(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TSoftObjectPtr<class UWorld>                  LevelReference;                                    // 0x05B8(0x0030)(Edit, BlueprintVisible, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnVisitorEntered;                                  // 0x05E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	uint8                                         Pad_4717[0x8];                                     // 0x05F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             PivotInitialPosition;                              // 0x0600(0x0060)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          RotatingCW;                                        // 0x0660(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          RotatingCCW;                                       // 0x0661(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4718[0x6];                                     // 0x0662(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        RotationTimer;                                     // 0x0668(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCurveFloat*                            RotationEaseInCurve;                               // 0x0670(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_HousingPlotActor_C) == 0x000680, "Wrong size on ABP_HousingPlotActor_C");
...
static_assert(offsetof(ABP_HousingPlotActor_C, OnVisitorEntered) == 0x0005E8, "Member 'ABP_HousingPlotActor_C::OnVisitorEntered' has a wrong offset!");
static_assert(offsetof(ABP_HousingPlotActor_C, PivotInitialPosition) == 0x000600, "Member 'ABP_HousingPlotActor_C::PivotInitialPosition' has a wrong offset!");
static_assert(offsetof(ABP_HousingPlotActor_C, RotatingCW) == 0x000660, "Member 'ABP_HousingPlotActor_C::RotatingCW' has a wrong offset!");
static_assert(offsetof(ABP_HousingPlotActor_C, RotatingCCW) == 0x000661, "Member 'ABP_HousingPlotActor_C::RotatingCCW' has a wrong offset!");
static_assert(offsetof(ABP_HousingPlotActor_C, RotationTimer) == 0x000668, "Member 'ABP_HousingPlotActor_C::RotationTimer' has a wrong offset!");
static_assert(offsetof(ABP_HousingPlotActor_C, RotationEaseInCurve) == 0x000670, "Member 'ABP_HousingPlotActor_C::RotationEaseInCurve' has a wrong offset!");
