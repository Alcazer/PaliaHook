...
public:
	...
	uint8                                         Pad_187E[0x3];                                     // 0x0045(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_187F[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1880[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FMovieSceneMediaSectionParams) == 0x000160, "Wrong size on FMovieSceneMediaSectionParams");
...
static_assert(offsetof(FMovieSceneMediaSectionParams, MediaSourceProxy) == 0x000010, "Member 'FMovieSceneMediaSectionParams::MediaSourceProxy' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaSectionParams, MediaSourceProxyIndex) == 0x000028, "Member 'FMovieSceneMediaSectionParams::MediaSourceProxyIndex' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaSectionParams, MediaTexture) == 0x000030, "Member 'FMovieSceneMediaSectionParams::MediaTexture' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaSectionParams, MediaPlayer) == 0x000038, "Member 'FMovieSceneMediaSectionParams::MediaPlayer' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaSectionParams, SectionStartFrame) == 0x000040, "Member 'FMovieSceneMediaSectionParams::SectionStartFrame' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaSectionParams, SectionEndFrame) == 0x000044, "Member 'FMovieSceneMediaSectionParams::SectionEndFrame' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaSectionParams, bLooping) == 0x000048, "Member 'FMovieSceneMediaSectionParams::bLooping' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaSectionParams, StartFrameOffset) == 0x00004C, "Member 'FMovieSceneMediaSectionParams::StartFrameOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneMediaSectionParams, ProxyTextureBlend) == 0x000050, "Member 'FMovieSceneMediaSectionParams::ProxyTextureBlend' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneMediaSectionTemplate) == 0x000188, "Wrong size on FMovieSceneMediaSectionTemplate");
...
static_assert(offsetof(FMovieSceneMediaSectionTemplate, MediaSection) == 0x000180, "Member 'FMovieSceneMediaSectionTemplate::MediaSection' has a wrong offset!");
