...
static_assert(sizeof(WBP_KeyRebindSelector_C_OnKeyDown) == 0x0001F0, "Wrong size on WBP_KeyRebindSelector_C_OnKeyDown");
...
static_assert(offsetof(WBP_KeyRebindSelector_C_OnKeyDown, InKeyEvent) == 0x000040, "Member 'WBP_KeyRebindSelector_C_OnKeyDown::InKeyEvent' has a wrong offset!");
static_assert(offsetof(WBP_KeyRebindSelector_C_OnKeyDown, ReturnValue) == 0x000080, "Member 'WBP_KeyRebindSelector_C_OnKeyDown::ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_KeyRebindSelector_C_OnKeyDown, CallFunc_Handled_ReturnValue) == 0x000138, "Member 'WBP_KeyRebindSelector_C_OnKeyDown::CallFunc_Handled_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_450F[0x6];                                     // 0x001A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
