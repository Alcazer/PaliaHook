...
// 0x0008 (0x0008 - 0x0000)
struct WBP_PopupHasButtonNotBound_KeyRebind_PF_C_OnConfirm__DelegateSignature final 
{
public:
...
static_assert(alignof(WBP_PopupHasButtonNotBound_KeyRebind_PF_C_OnConfirm__DelegateSignature) == 0x000008, "Wrong alignment on WBP_PopupHasButtonNotBound_KeyRebind_PF_C_OnConfirm__DelegateSignature");
static_assert(sizeof(WBP_PopupHasButtonNotBound_KeyRebind_PF_C_OnConfirm__DelegateSignature) == 0x000008, "Wrong size on WBP_PopupHasButtonNotBound_KeyRebind_PF_C_OnConfirm__DelegateSignature");
static_assert(offsetof(WBP_PopupHasButtonNotBound_KeyRebind_PF_C_OnConfirm__DelegateSignature, Param_OwnerWidget) == 0x000000, "Member 'WBP_PopupHasButtonNotBound_KeyRebind_PF_C_OnConfirm__DelegateSignature::Param_OwnerWidget' has a wrong offset!");
