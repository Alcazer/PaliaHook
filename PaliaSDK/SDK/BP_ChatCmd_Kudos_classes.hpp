...
#include "BP_ChatCmd_Report_classes.hpp"


namespace SDK
{

// BlueprintGeneratedClass BP_ChatCmd_Kudos.BP_ChatCmd_Kudos_C
// 0x0000 (0x0198 - 0x0198)
class UBP_ChatCmd_Kudos_C final  : public UBP_ChatCmd_Report_C
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_ChatCmd_Kudos_C">();
	}
	static class UBP_ChatCmd_Kudos_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBP_ChatCmd_Kudos_C>();
	}
};
static_assert(alignof(UBP_ChatCmd_Kudos_C) == 0x000008, "Wrong alignment on UBP_ChatCmd_Kudos_C");
static_assert(sizeof(UBP_ChatCmd_Kudos_C) == 0x000198, "Wrong size on UBP_ChatCmd_Kudos_C");
