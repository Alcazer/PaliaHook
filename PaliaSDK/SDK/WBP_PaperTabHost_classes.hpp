...
static_assert(sizeof(UWBP_PaperTabHost_C) == 0x000320, "Wrong size on UWBP_PaperTabHost_C");
static_assert(offsetof(UWBP_PaperTabHost_C, UberGraphFrame) == 0x0002F0, "Member 'UWBP_PaperTabHost_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_PaperTabHost_C, HBox_TabButtons) == 0x0002F8, "Member 'UWBP_PaperTabHost_C::HBox_TabButtons' has a wrong offset!");
static_assert(offsetof(UWBP_PaperTabHost_C, ButtonPadding_Inactive) == 0x000300, "Member 'UWBP_PaperTabHost_C::ButtonPadding_Inactive' has a wrong offset!");
static_assert(offsetof(UWBP_PaperTabHost_C, ButtonPadding_Active) == 0x000310, "Member 'UWBP_PaperTabHost_C::ButtonPadding_Active' has a wrong offset!");
