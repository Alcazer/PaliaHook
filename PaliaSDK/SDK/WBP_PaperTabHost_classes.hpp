...
// WidgetBlueprintGeneratedClass WBP_PaperTabHost.WBP_PaperTabHost_C
// 0x0030 (0x0368 - 0x0338)
class UWBP_PaperTabHost_C final  : public UVALUI_TabButtonHostBase
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_PaperTabHost_C">();
	}
	static class UWBP_PaperTabHost_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_PaperTabHost_C>();
	}
};
static_assert(alignof(UWBP_PaperTabHost_C) == 0x000008, "Wrong alignment on UWBP_PaperTabHost_C");
static_assert(sizeof(UWBP_PaperTabHost_C) == 0x000368, "Wrong size on UWBP_PaperTabHost_C");
static_assert(offsetof(UWBP_PaperTabHost_C, UberGraphFrame) == 0x000338, "Member 'UWBP_PaperTabHost_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_PaperTabHost_C, HBox_TabButtons) == 0x000340, "Member 'UWBP_PaperTabHost_C::HBox_TabButtons' has a wrong offset!");
static_assert(offsetof(UWBP_PaperTabHost_C, ButtonPadding_Inactive) == 0x000348, "Member 'UWBP_PaperTabHost_C::ButtonPadding_Inactive' has a wrong offset!");
static_assert(offsetof(UWBP_PaperTabHost_C, ButtonPadding_Active) == 0x000358, "Member 'UWBP_PaperTabHost_C::ButtonPadding_Active' has a wrong offset!");
