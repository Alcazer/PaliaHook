...
public:
	...
	uint8                                         Pad_3BEA[0x18];                                    // 0x0038(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static class UAndroidPermissionCallbackProxy* AcquirePermissions(TArray<class FString>& Permissions);
