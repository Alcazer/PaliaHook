...
{
public:
	class UVALUI_TextBlock_Styled*                HighScoreLabel;                                    // 0x0278(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_TextBlock_Styled*                ScoreText;                                         // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVAL_ScoreComponent*                    ScoreComponent;                                    // 0x0288(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UVAL_ScoreDefinition*                   ScoreToDisplay;                                    // 0x0290(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_HighScore_C) == 0x000298, "Wrong size on UWBP_HighScore_C");
static_assert(offsetof(UWBP_HighScore_C, HighScoreLabel) == 0x000278, "Member 'UWBP_HighScore_C::HighScoreLabel' has a wrong offset!");
static_assert(offsetof(UWBP_HighScore_C, ScoreText) == 0x000280, "Member 'UWBP_HighScore_C::ScoreText' has a wrong offset!");
static_assert(offsetof(UWBP_HighScore_C, ScoreComponent) == 0x000288, "Member 'UWBP_HighScore_C::ScoreComponent' has a wrong offset!");
static_assert(offsetof(UWBP_HighScore_C, ScoreToDisplay) == 0x000290, "Member 'UWBP_HighScore_C::ScoreToDisplay' has a wrong offset!");
