...
public:
	...
	class UWBP_PaperTabHost_C*                    BasicHorizontalTabButtonHost_ItemCategories;       // 0x04E8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Template_Button_Primary_01_CM_C*   Button_RequestItem;                                // 0x04F0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UTileView*                              TileView_ItemTypes;                                // 0x04F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_RadioSlider_Template_02_CM_C*      WBP_RadioSlider_CategoryFilters_1;                 // 0x0500(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_RequestAmmo_C*                     WBP_RequestAmmo;                                   // 0x0508(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnCommit;                                          // 0x0510(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class UVAL_ItemTypeDefinitionAsset*           PreSelectedItem;                                   // 0x0520(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnTileViewPopulated;                               // 0x0528(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class UVAL_EncyclopediaManagerComponent*      EncylopediaManagerComp;                            // 0x0538(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TArray<EItemStorageCategory>                  AllRequestableCategories;                          // 0x0540(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	TSoftObjectPtr<class UVAL_TutorialFlagDefinition> Requests_Flag;                                     // 0x0550(0x0030)(Edit, BlueprintVisible, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnBack;                                            // 0x0580(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	double                                        Scroll_Speed;                                      // 0x0590(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CurrentSelectedIndex;                              // 0x0598(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_RequestItemPicker_CM_C) == 0x0005A0, "Wrong size on UWBP_RequestItemPicker_CM_C");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, UberGraphFrame) == 0x0004E0, "Member 'UWBP_RequestItemPicker_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, BasicHorizontalTabButtonHost_ItemCategories) == 0x0004E8, "Member 'UWBP_RequestItemPicker_CM_C::BasicHorizontalTabButtonHost_ItemCategories' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, Button_RequestItem) == 0x0004F0, "Member 'UWBP_RequestItemPicker_CM_C::Button_RequestItem' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, TileView_ItemTypes) == 0x0004F8, "Member 'UWBP_RequestItemPicker_CM_C::TileView_ItemTypes' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, WBP_RadioSlider_CategoryFilters_1) == 0x000500, "Member 'UWBP_RequestItemPicker_CM_C::WBP_RadioSlider_CategoryFilters_1' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, WBP_RequestAmmo) == 0x000508, "Member 'UWBP_RequestItemPicker_CM_C::WBP_RequestAmmo' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, OnCommit) == 0x000510, "Member 'UWBP_RequestItemPicker_CM_C::OnCommit' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, PreSelectedItem) == 0x000520, "Member 'UWBP_RequestItemPicker_CM_C::PreSelectedItem' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, OnTileViewPopulated) == 0x000528, "Member 'UWBP_RequestItemPicker_CM_C::OnTileViewPopulated' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, EncylopediaManagerComp) == 0x000538, "Member 'UWBP_RequestItemPicker_CM_C::EncylopediaManagerComp' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, AllRequestableCategories) == 0x000540, "Member 'UWBP_RequestItemPicker_CM_C::AllRequestableCategories' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, Requests_Flag) == 0x000550, "Member 'UWBP_RequestItemPicker_CM_C::Requests_Flag' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, OnBack) == 0x000580, "Member 'UWBP_RequestItemPicker_CM_C::OnBack' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, Scroll_Speed) == 0x000590, "Member 'UWBP_RequestItemPicker_CM_C::Scroll_Speed' has a wrong offset!");
static_assert(offsetof(UWBP_RequestItemPicker_CM_C, CurrentSelectedIndex) == 0x000598, "Member 'UWBP_RequestItemPicker_CM_C::CurrentSelectedIndex' has a wrong offset!");
