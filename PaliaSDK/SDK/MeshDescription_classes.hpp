...
{
public:
	uint8                                         Pad_11E1[0x2C8];                                   // 0x0028(0x02C8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetEdgeVertices(struct FEdgeID& EdgeID, TArray<struct FVertexID>* OutVertexIDs) const;
	...
	bool IsTriangleValid(struct FTriangleID& TriangleID) const;
