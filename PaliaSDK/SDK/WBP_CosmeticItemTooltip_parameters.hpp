...
public:
	...
	uint8                                         Pad_3C63[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C64[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FVAL_CharCustomization_AssetData       Param_Asset_Data;                                  // 0x0000(0x0130)(BlueprintVisible, BlueprintReadOnly, Parm)
	bool                                          CallFunc_GetConsoleVariableBoolValue_ReturnValue;  // 0x0130(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_CosmeticItemTooltip_C_InitializeFromAssetData) == 0x000138, "Wrong size on WBP_CosmeticItemTooltip_C_InitializeFromAssetData");
...
static_assert(offsetof(WBP_CosmeticItemTooltip_C_InitializeFromAssetData, CallFunc_GetConsoleVariableBoolValue_ReturnValue) == 0x000130, "Member 'WBP_CosmeticItemTooltip_C_InitializeFromAssetData::CallFunc_GetConsoleVariableBoolValue_ReturnValue' has a wrong offset!");
