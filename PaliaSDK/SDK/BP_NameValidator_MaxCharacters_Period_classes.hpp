...
// BlueprintGeneratedClass BP_NameValidator_MaxCharacters_Period.BP_NameValidator_MaxCharacters_Period_C
// 0x0008 (0x00A8 - 0x00A0)
class UBP_NameValidator_MaxCharacters_Period_C final  : public UVALUI_NameValidator_Regex
{
public:
	...
	uint8                                         Pad_3DBF[0x3];                                     // 0x00A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_NameValidator_MaxCharacters_Period_C">();
	}
	static class UBP_NameValidator_MaxCharacters_Period_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UBP_NameValidator_MaxCharacters_Period_C>();
	}
};
static_assert(alignof(UBP_NameValidator_MaxCharacters_Period_C) == 0x000008, "Wrong alignment on UBP_NameValidator_MaxCharacters_Period_C");
static_assert(sizeof(UBP_NameValidator_MaxCharacters_Period_C) == 0x0000A8, "Wrong size on UBP_NameValidator_MaxCharacters_Period_C");
static_assert(offsetof(UBP_NameValidator_MaxCharacters_Period_C, Values_Built) == 0x0000A0, "Member 'UBP_NameValidator_MaxCharacters_Period_C::Values_Built' has a wrong offset!");
static_assert(offsetof(UBP_NameValidator_MaxCharacters_Period_C, MaxNumber) == 0x0000A4, "Member 'UBP_NameValidator_MaxCharacters_Period_C::MaxNumber' has a wrong offset!");
