...
static_assert(sizeof(UWBP_PopupHasButtonNotBound_KeyRebind_C) == 0x000550, "Wrong size on UWBP_PopupHasButtonNotBound_KeyRebind_C");
static_assert(offsetof(UWBP_PopupHasButtonNotBound_KeyRebind_C, UberGraphFrame) == 0x000528, "Member 'UWBP_PopupHasButtonNotBound_KeyRebind_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_PopupHasButtonNotBound_KeyRebind_C, WBP_Template_PopupSecondary_02_CM) == 0x000530, "Member 'UWBP_PopupHasButtonNotBound_KeyRebind_C::WBP_Template_PopupSecondary_02_CM' has a wrong offset!");
static_assert(offsetof(UWBP_PopupHasButtonNotBound_KeyRebind_C, OnConfirm) == 0x000538, "Member 'UWBP_PopupHasButtonNotBound_KeyRebind_C::OnConfirm' has a wrong offset!");
static_assert(offsetof(UWBP_PopupHasButtonNotBound_KeyRebind_C, OwnerWidget) == 0x000548, "Member 'UWBP_PopupHasButtonNotBound_KeyRebind_C::OwnerWidget' has a wrong offset!");
