...
static_assert(sizeof(UWBP_AnimatedLoading_Chapaa_C) == 0x000280, "Wrong size on UWBP_AnimatedLoading_Chapaa_C");
static_assert(offsetof(UWBP_AnimatedLoading_Chapaa_C, Image_Loading) == 0x000278, "Member 'UWBP_AnimatedLoading_Chapaa_C::Image_Loading' has a wrong offset!");
