...
{
public:
	class UWidgetAnimation*                       SuccessfulHit;                                     // 0x0278(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, RepSkip, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Cooking_Minigame_RollingPin_Marker_C) == 0x000280, "Wrong size on UWBP_Cooking_Minigame_RollingPin_Marker_C");
static_assert(offsetof(UWBP_Cooking_Minigame_RollingPin_Marker_C, SuccessfulHit) == 0x000278, "Member 'UWBP_Cooking_Minigame_RollingPin_Marker_C::SuccessfulHit' has a wrong offset!");
