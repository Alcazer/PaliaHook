...
// 0x0AF0 (0x0E40 - 0x0350)
class UABP_Kenyatta_PostProcess_C final  : public UAnimInstance
{
public:
	uint8                                         Pad_3DA7[0x8];                                     // 0x0348(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x0350(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	struct FAnimSubsystemInstance                 AnimBlueprintExtension_PropertyAccess;             // 0x0358(0x0008)()
	struct FAnimSubsystemInstance                 AnimBlueprintExtension_Base;                       // 0x0360(0x0008)()
	struct FAnimNode_Root                         AnimGraphNode_Root;                                // 0x0368(0x0020)()
	uint8                                         Pad_3DA8[0x8];                                     // 0x0388(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FAnimNode_LinkedInputPose              AnimGraphNode_LinkedInputPose;                     // 0x0D70(0x00C8)()
...
static_assert(sizeof(UABP_Kenyatta_PostProcess_C) == 0x000E40, "Wrong size on UABP_Kenyatta_PostProcess_C");
...
static_assert(offsetof(UABP_Kenyatta_PostProcess_C, AnimGraphNode_LocalToComponentSpace) == 0x000D30, "Member 'UABP_Kenyatta_PostProcess_C::AnimGraphNode_LocalToComponentSpace' has a wrong offset!");
static_assert(offsetof(UABP_Kenyatta_PostProcess_C, AnimGraphNode_ComponentToLocalSpace) == 0x000D50, "Member 'UABP_Kenyatta_PostProcess_C::AnimGraphNode_ComponentToLocalSpace' has a wrong offset!");
static_assert(offsetof(UABP_Kenyatta_PostProcess_C, AnimGraphNode_LinkedInputPose) == 0x000D70, "Member 'UABP_Kenyatta_PostProcess_C::AnimGraphNode_LinkedInputPose' has a wrong offset!");
