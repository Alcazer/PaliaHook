...
public:
	...
	struct FInt64Split                            EndValeriaTimeMs;                                  // 0x0288(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	int32                                         TimeRemainingSecs_Prev;                            // 0x0290(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bShouldDisplayAsFreshness;                         // 0x0294(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bUseClockFormat;                                   // 0x0295(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_44CD[0x2];                                     // 0x0296(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class UVALUI_TextBlockStyle*                  TimerTextStyle;                                    // 0x0298(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FDateTime                              EndDateTime;                                       // 0x02A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          bIsEndTimeSet;                                     // 0x02A8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bUseDateTime;                                      // 0x02A9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_CountdownTimerTextOnly_C) == 0x0002B0, "Wrong size on UWBP_CountdownTimerTextOnly_C");
static_assert(offsetof(UWBP_CountdownTimerTextOnly_C, UberGraphFrame) == 0x000278, "Member 'UWBP_CountdownTimerTextOnly_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_CountdownTimerTextOnly_C, TimerText) == 0x000280, "Member 'UWBP_CountdownTimerTextOnly_C::TimerText' has a wrong offset!");
static_assert(offsetof(UWBP_CountdownTimerTextOnly_C, EndValeriaTimeMs) == 0x000288, "Member 'UWBP_CountdownTimerTextOnly_C::EndValeriaTimeMs' has a wrong offset!");
static_assert(offsetof(UWBP_CountdownTimerTextOnly_C, TimeRemainingSecs_Prev) == 0x000290, "Member 'UWBP_CountdownTimerTextOnly_C::TimeRemainingSecs_Prev' has a wrong offset!");
static_assert(offsetof(UWBP_CountdownTimerTextOnly_C, bShouldDisplayAsFreshness) == 0x000294, "Member 'UWBP_CountdownTimerTextOnly_C::bShouldDisplayAsFreshness' has a wrong offset!");
static_assert(offsetof(UWBP_CountdownTimerTextOnly_C, bUseClockFormat) == 0x000295, "Member 'UWBP_CountdownTimerTextOnly_C::bUseClockFormat' has a wrong offset!");
static_assert(offsetof(UWBP_CountdownTimerTextOnly_C, TimerTextStyle) == 0x000298, "Member 'UWBP_CountdownTimerTextOnly_C::TimerTextStyle' has a wrong offset!");
static_assert(offsetof(UWBP_CountdownTimerTextOnly_C, EndDateTime) == 0x0002A0, "Member 'UWBP_CountdownTimerTextOnly_C::EndDateTime' has a wrong offset!");
static_assert(offsetof(UWBP_CountdownTimerTextOnly_C, bIsEndTimeSet) == 0x0002A8, "Member 'UWBP_CountdownTimerTextOnly_C::bIsEndTimeSet' has a wrong offset!");
static_assert(offsetof(UWBP_CountdownTimerTextOnly_C, bUseDateTime) == 0x0002A9, "Member 'UWBP_CountdownTimerTextOnly_C::bUseDateTime' has a wrong offset!");
