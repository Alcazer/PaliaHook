...
struct WebBrowser_OnConsoleMessage__DelegateSignature final 
{
public:
	...
	uint8                                         Pad_2C27[0x4];                                     // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(WebBrowser_OnConsoleMessage__DelegateSignature, Message) == 0x000000, "Member 'WebBrowser_OnConsoleMessage__DelegateSignature::Message' has a wrong offset!");
static_assert(offsetof(WebBrowser_OnConsoleMessage__DelegateSignature, Source) == 0x000010, "Member 'WebBrowser_OnConsoleMessage__DelegateSignature::Source' has a wrong offset!");
static_assert(offsetof(WebBrowser_OnConsoleMessage__DelegateSignature, Line) == 0x000020, "Member 'WebBrowser_OnConsoleMessage__DelegateSignature::Line' has a wrong offset!");
