...
public:
	...
	class UCommonVisibilitySwitcher*              CommonVisibilitySwitcher_105;                      // 0x0530(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_PopupEULA_CM_C) == 0x000580, "Wrong size on UWBP_PopupEULA_CM_C");
static_assert(offsetof(UWBP_PopupEULA_CM_C, UberGraphFrame) == 0x000528, "Member 'UWBP_PopupEULA_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_PopupEULA_CM_C, CommonVisibilitySwitcher_105) == 0x000530, "Member 'UWBP_PopupEULA_CM_C::CommonVisibilitySwitcher_105' has a wrong offset!");
static_assert(offsetof(UWBP_PopupEULA_CM_C, RichTextBlock_Message) == 0x000538, "Member 'UWBP_PopupEULA_CM_C::RichTextBlock_Message' has a wrong offset!");
static_assert(offsetof(UWBP_PopupEULA_CM_C, Scrollbox_Message) == 0x000540, "Member 'UWBP_PopupEULA_CM_C::Scrollbox_Message' has a wrong offset!");
static_assert(offsetof(UWBP_PopupEULA_CM_C, WBP_CommonUIButtonPrompt) == 0x000548, "Member 'UWBP_PopupEULA_CM_C::WBP_CommonUIButtonPrompt' has a wrong offset!");
static_assert(offsetof(UWBP_PopupEULA_CM_C, WBP_Template_Button_Primary_01_CM) == 0x000550, "Member 'UWBP_PopupEULA_CM_C::WBP_Template_Button_Primary_01_CM' has a wrong offset!");
static_assert(offsetof(UWBP_PopupEULA_CM_C, WBP_Template_PopupSecondary_02_CM) == 0x000558, "Member 'UWBP_PopupEULA_CM_C::WBP_Template_PopupSecondary_02_CM' has a wrong offset!");
static_assert(offsetof(UWBP_PopupEULA_CM_C, WidgetSwitcher_MessageState) == 0x000560, "Member 'UWBP_PopupEULA_CM_C::WidgetSwitcher_MessageState' has a wrong offset!");
static_assert(offsetof(UWBP_PopupEULA_CM_C, OnConfirm) == 0x000568, "Member 'UWBP_PopupEULA_CM_C::OnConfirm' has a wrong offset!");
static_assert(offsetof(UWBP_PopupEULA_CM_C, ScrollScale) == 0x000578, "Member 'UWBP_PopupEULA_CM_C::ScrollScale' has a wrong offset!");
