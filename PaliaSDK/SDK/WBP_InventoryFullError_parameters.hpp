...
public:
	...
	uint8                                         Pad_4AE3[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_InventoryFullError_C_MatchesNotification) == 0x000050, "Wrong size on WBP_InventoryFullError_C_MatchesNotification");
...
static_assert(offsetof(WBP_InventoryFullError_C_MatchesNotification, ReturnValue) == 0x000048, "Member 'WBP_InventoryFullError_C_MatchesNotification::ReturnValue' has a wrong offset!");
