...
public:
	...
	class UImage*                                 Image_GamepadSelect;                               // 0x02B0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_CommonInputActionWidget_C*         WBP_CommonInputActionWidget;                       // 0x02B8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_ItemSlot_CM_C*                     WBP_ItemSlot_CM;                                   // 0x02C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_ToolBacker_CM_C*                   WBP_ToolBacker_CM;                                 // 0x02C8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_ToolItem_CM_C*                     WBP_ToolItem_CM;                                   // 0x02D0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	int32                                         BagSlotIndex;                                      // 0x02D8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	uint8                                         Pad_3606[0x4];                                     // 0x02DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnSecondaryClicked;                                // 0x02E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                          bAllowDrag;                                        // 0x02F0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	uint8                                         Pad_3607[0x7];                                     // 0x02F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnToolClicked;                                     // 0x02F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class UMaterialInstanceDynamic*               DurabilityDynamicMaterial;                         // 0x0308(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*               WaterDynamicMaterial;                              // 0x0310(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          bUseEquippedToolAsSelected;                        // 0x0318(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	uint8                                         Pad_3608[0x7];                                     // 0x0319(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnToolGamepadSelected;                             // 0x0320(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnToolGamepadCanceld;                              // 0x0330(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                          IsGamepadSelected;                                 // 0x0340(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3609[0x7];                                     // 0x0341(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Hold_Widget_Name;                                  // 0x0348(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnToolTileGamepadFocused;                          // 0x0358(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnToolTileTouchEnded;                              // 0x0368(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(UWBP_ToolTile_CM_C) == 0x000378, "Wrong size on UWBP_ToolTile_CM_C");
static_assert(offsetof(UWBP_ToolTile_CM_C, UberGraphFrame) == 0x0002A0, "Member 'UWBP_ToolTile_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, HoverAnim) == 0x0002A8, "Member 'UWBP_ToolTile_CM_C::HoverAnim' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, Image_GamepadSelect) == 0x0002B0, "Member 'UWBP_ToolTile_CM_C::Image_GamepadSelect' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, WBP_CommonInputActionWidget) == 0x0002B8, "Member 'UWBP_ToolTile_CM_C::WBP_CommonInputActionWidget' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, WBP_ItemSlot_CM) == 0x0002C0, "Member 'UWBP_ToolTile_CM_C::WBP_ItemSlot_CM' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, WBP_ToolBacker_CM) == 0x0002C8, "Member 'UWBP_ToolTile_CM_C::WBP_ToolBacker_CM' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, WBP_ToolItem_CM) == 0x0002D0, "Member 'UWBP_ToolTile_CM_C::WBP_ToolItem_CM' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, BagSlotIndex) == 0x0002D8, "Member 'UWBP_ToolTile_CM_C::BagSlotIndex' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, OnSecondaryClicked) == 0x0002E0, "Member 'UWBP_ToolTile_CM_C::OnSecondaryClicked' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, bAllowDrag) == 0x0002F0, "Member 'UWBP_ToolTile_CM_C::bAllowDrag' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, OnToolClicked) == 0x0002F8, "Member 'UWBP_ToolTile_CM_C::OnToolClicked' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, DurabilityDynamicMaterial) == 0x000308, "Member 'UWBP_ToolTile_CM_C::DurabilityDynamicMaterial' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, WaterDynamicMaterial) == 0x000310, "Member 'UWBP_ToolTile_CM_C::WaterDynamicMaterial' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, bUseEquippedToolAsSelected) == 0x000318, "Member 'UWBP_ToolTile_CM_C::bUseEquippedToolAsSelected' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, OnToolGamepadSelected) == 0x000320, "Member 'UWBP_ToolTile_CM_C::OnToolGamepadSelected' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, OnToolGamepadCanceld) == 0x000330, "Member 'UWBP_ToolTile_CM_C::OnToolGamepadCanceld' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, IsGamepadSelected) == 0x000340, "Member 'UWBP_ToolTile_CM_C::IsGamepadSelected' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, Hold_Widget_Name) == 0x000348, "Member 'UWBP_ToolTile_CM_C::Hold_Widget_Name' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, OnToolTileGamepadFocused) == 0x000358, "Member 'UWBP_ToolTile_CM_C::OnToolTileGamepadFocused' has a wrong offset!");
static_assert(offsetof(UWBP_ToolTile_CM_C, OnToolTileTouchEnded) == 0x000368, "Member 'UWBP_ToolTile_CM_C::OnToolTileTouchEnded' has a wrong offset!");
