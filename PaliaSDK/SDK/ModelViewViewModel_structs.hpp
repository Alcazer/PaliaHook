...
public:
	...
	uint8                                         Pad_18D7[0x1];                                     // 0x000B(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_18D8[0x1];                                     // 0x0003(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FMVVMVCompiledBinding) == 0x00000C, "Wrong size on FMVVMVCompiledBinding");
...
{
public:
	uint8                                         Pad_18D9[0x10];                                    // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18DA[0x10];                                    // 0x0020(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18DB[0x18];                                    // 0x0010(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_18DC[0x2];                                     // 0x0026(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMVVMViewClass_SourceCreator) == 0x000008, "Wrong alignment on FMVVMViewClass_SourceCreator");
static_assert(sizeof(FMVVMViewClass_SourceCreator) == 0x000028, "Wrong size on FMVVMViewClass_SourceCreator");
...
static_assert(offsetof(FMVVMViewClass_SourceCreator, GlobalViewModelInstance) == 0x000008, "Member 'FMVVMViewClass_SourceCreator::GlobalViewModelInstance' has a wrong offset!");
static_assert(offsetof(FMVVMViewClass_SourceCreator, FieldPath) == 0x000018, "Member 'FMVVMViewClass_SourceCreator::FieldPath' has a wrong offset!");
static_assert(offsetof(FMVVMViewClass_SourceCreator, PropertyName) == 0x00001C, "Member 'FMVVMViewClass_SourceCreator::PropertyName' has a wrong offset!");
static_assert(offsetof(FMVVMViewClass_SourceCreator, bCreateInstance) == 0x000024, "Member 'FMVVMViewClass_SourceCreator::bCreateInstance' has a wrong offset!");
static_assert(offsetof(FMVVMViewClass_SourceCreator, bOptional) == 0x000025, "Member 'FMVVMViewClass_SourceCreator::bOptional' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_18DD[0x2];                                     // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	EMVVMViewBindingUpdateMode                    UpdateMode;                                        // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Flags;                                             // 0x0019(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_18DE[0x2];                                     // 0x001A(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FMVVMViewClass_CompiledBinding, UpdateMode) == 0x000018, "Member 'FMVVMViewClass_CompiledBinding::UpdateMode' has a wrong offset!");
static_assert(offsetof(FMVVMViewClass_CompiledBinding, Flags) == 0x000019, "Member 'FMVVMViewClass_CompiledBinding::Flags' has a wrong offset!");
