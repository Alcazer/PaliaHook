...
bool UCineCameraSettings::GetFilmbackPresetByName(class FString& PresetName, struct FCameraFilmbackSettings* FilmbackSettings)
{
	static class UFunction* Func = nullptr;
...
bool UCineCameraSettings::GetLensPresetByName(class FString& PresetName, struct FCameraLensSettings* LensSettings)
{
	static class UFunction* Func = nullptr;
...
void UCineCameraSettings::SetDefaultCropPresetName(class FString& InDefaultCropPresetName)
{
	static class UFunction* Func = nullptr;
...
void UCineCameraSettings::SetDefaultFilmbackPreset(class FString& InDefaultFilmbackPreset)
{
	static class UFunction* Func = nullptr;
...
void UCineCameraSettings::SetDefaultLensPresetName(class FString& InDefaultLensPresetName)
{
	static class UFunction* Func = nullptr;
