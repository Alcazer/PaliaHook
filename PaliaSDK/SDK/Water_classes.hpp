...
public:
	...
	uint8                                         Pad_168E[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_168F[0x90];                                    // 0x0178(0x0090)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1690[0x50];                                    // 0x02A0(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UBuoyancyComponent*>             BuoyancyComponents;                                // 0x02F0(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1691[0x68];                                    // 0x0300(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ABuoyancyManager) == 0x000368, "Wrong size on ABuoyancyManager");
static_assert(offsetof(ABuoyancyManager, BuoyancyComponents) == 0x0002F0, "Member 'ABuoyancyManager::BuoyancyComponents' has a wrong offset!");

// Class Water.WaterBodyComponent
// 0x0FF0 (0x1530 - 0x0540)
...
public:
	...
	uint8                                         Pad_1693[0x8];                                     // 0x0548(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UMaterialInterface*                     WaterHLODMaterial;                                 // 0x0C78(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     WaterLODMaterial;                                  // 0x0C80(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     UnderwaterPostProcessMaterial;                     // 0x0C88(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     WaterInfoMaterial;                                 // 0x0C90(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FWaterBodyHeightmapSettings            WaterHeightmapSettings;                            // 0x0C98(0x0080)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_1694[0x3];                                     // 0x0D21(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1695[0x3];                                     // 0x0D31(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UMaterialInstanceDynamic*               WaterLODMID;                                       // 0x0D48(0x0008)(Edit, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, NoDestructor, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               UnderwaterPostProcessMID;                          // 0x0D50(0x0008)(Edit, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, NoDestructor, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               WaterInfoMID;                                      // 0x0D58(0x0008)(Edit, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, NoDestructor, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<TSoftObjectPtr<class AWaterBodyIsland>> WaterBodyIslands;                                  // 0x0D60(0x0010)(Edit, ZeroConstructor, EditConst, AdvancedDisplay, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<TSoftObjectPtr<class AWaterBodyExclusionVolume>> WaterBodyExclusionVolumes;                         // 0x0D70(0x0010)(Edit, ZeroConstructor, EditConst, AdvancedDisplay, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_1696[0x8];                                     // 0x0DE8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1697[0x50];                                    // 0x14D8(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWaterBodyComponent) == 0x001530, "Wrong size on UWaterBodyComponent");
static_assert(offsetof(UWaterBodyComponent, PhysicalMaterial) == 0x000538, "Member 'UWaterBodyComponent::PhysicalMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, TargetWaveMaskDepth) == 0x000540, "Member 'UWaterBodyComponent::TargetWaveMaskDepth' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, MaxWaveHeightOffset) == 0x000544, "Member 'UWaterBodyComponent::MaxWaveHeightOffset' has a wrong offset!");
...
static_assert(offsetof(UWaterBodyComponent, CurveSettings) == 0x000C50, "Member 'UWaterBodyComponent::CurveSettings' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterMaterial) == 0x000C70, "Member 'UWaterBodyComponent::WaterMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterHLODMaterial) == 0x000C78, "Member 'UWaterBodyComponent::WaterHLODMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterLODMaterial) == 0x000C80, "Member 'UWaterBodyComponent::WaterLODMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, UnderwaterPostProcessMaterial) == 0x000C88, "Member 'UWaterBodyComponent::UnderwaterPostProcessMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterInfoMaterial) == 0x000C90, "Member 'UWaterBodyComponent::WaterInfoMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterHeightmapSettings) == 0x000C98, "Member 'UWaterBodyComponent::WaterHeightmapSettings' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, ShapeDilation) == 0x000D18, "Member 'UWaterBodyComponent::ShapeDilation' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, CollisionHeightOffset) == 0x000D1C, "Member 'UWaterBodyComponent::CollisionHeightOffset' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, bAffectsLandscape) == 0x000D20, "Member 'UWaterBodyComponent::bAffectsLandscape' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterBodyIndex) == 0x000D24, "Member 'UWaterBodyComponent::WaterBodyIndex' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterMeshOverride) == 0x000D28, "Member 'UWaterBodyComponent::WaterMeshOverride' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, bAlwaysGenerateWaterMeshTiles) == 0x000D30, "Member 'UWaterBodyComponent::bAlwaysGenerateWaterMeshTiles' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, OverlapMaterialPriority) == 0x000D34, "Member 'UWaterBodyComponent::OverlapMaterialPriority' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterSplineMetadata) == 0x000D38, "Member 'UWaterBodyComponent::WaterSplineMetadata' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterMID) == 0x000D40, "Member 'UWaterBodyComponent::WaterMID' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterLODMID) == 0x000D48, "Member 'UWaterBodyComponent::WaterLODMID' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, UnderwaterPostProcessMID) == 0x000D50, "Member 'UWaterBodyComponent::UnderwaterPostProcessMID' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterInfoMID) == 0x000D58, "Member 'UWaterBodyComponent::WaterInfoMID' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterBodyIslands) == 0x000D60, "Member 'UWaterBodyComponent::WaterBodyIslands' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, WaterBodyExclusionVolumes) == 0x000D70, "Member 'UWaterBodyComponent::WaterBodyExclusionVolumes' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, Landscape) == 0x000D80, "Member 'UWaterBodyComponent::Landscape' has a wrong offset!");
static_assert(offsetof(UWaterBodyComponent, OwningWaterZone) == 0x000D88, "Member 'UWaterBodyComponent::OwningWaterZone' has a wrong offset!");
...
static_assert(offsetof(UWaterBodyComponent, CurrentPostProcessSettings) == 0x000DF0, "Member 'UWaterBodyComponent::CurrentPostProcessSettings' has a wrong offset!");
...
static_assert(offsetof(UWaterBodyComponent, FixedWaterDepth) == 0x001528, "Member 'UWaterBodyComponent::FixedWaterDepth' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_169A[0x5];                                     // 0x01FB(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UTextureRenderTarget2D*                 WaterInfoTexture;                                  // 0x02A0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, DuplicateTransient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<TWeakObjectPtr<class UWaterBodyComponent>> OwnedWaterBodies;                                  // 0x02A8(0x0010)(Edit, ExportObject, ZeroConstructor, Transient, EditConst, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	struct FIntPoint                              RenderTargetResolution;                            // 0x02B8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWaterMeshComponent*                    WaterMesh;                                         // 0x02C0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector2D                              ZoneExtent;                                        // 0x02C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         CaptureZOffset;                                    // 0x02D8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bHalfPrecisionTexture;                             // 0x02DC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_169B[0x3];                                     // 0x02DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         VelocityBlurRadius;                                // 0x02E0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_169C[0x4];                                     // 0x02E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                TessellatedWaterMeshExtent;                        // 0x02E8(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint32                                        NonTessellatedLODSectionScale;                     // 0x0300(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         OverlapPriority;                                   // 0x0304(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bEnableNonTessellatedLODMesh;                      // 0x0308(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_169D[0x27];                                    // 0x0309(0x0027)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AWaterZone) == 0x000330, "Wrong size on AWaterZone");
static_assert(offsetof(AWaterZone, WaterInfoTexture) == 0x0002A0, "Member 'AWaterZone::WaterInfoTexture' has a wrong offset!");
static_assert(offsetof(AWaterZone, OwnedWaterBodies) == 0x0002A8, "Member 'AWaterZone::OwnedWaterBodies' has a wrong offset!");
static_assert(offsetof(AWaterZone, RenderTargetResolution) == 0x0002B8, "Member 'AWaterZone::RenderTargetResolution' has a wrong offset!");
static_assert(offsetof(AWaterZone, WaterMesh) == 0x0002C0, "Member 'AWaterZone::WaterMesh' has a wrong offset!");
static_assert(offsetof(AWaterZone, ZoneExtent) == 0x0002C8, "Member 'AWaterZone::ZoneExtent' has a wrong offset!");
static_assert(offsetof(AWaterZone, CaptureZOffset) == 0x0002D8, "Member 'AWaterZone::CaptureZOffset' has a wrong offset!");
static_assert(offsetof(AWaterZone, bHalfPrecisionTexture) == 0x0002DC, "Member 'AWaterZone::bHalfPrecisionTexture' has a wrong offset!");
static_assert(offsetof(AWaterZone, VelocityBlurRadius) == 0x0002E0, "Member 'AWaterZone::VelocityBlurRadius' has a wrong offset!");
static_assert(offsetof(AWaterZone, TessellatedWaterMeshExtent) == 0x0002E8, "Member 'AWaterZone::TessellatedWaterMeshExtent' has a wrong offset!");
static_assert(offsetof(AWaterZone, NonTessellatedLODSectionScale) == 0x000300, "Member 'AWaterZone::NonTessellatedLODSectionScale' has a wrong offset!");
static_assert(offsetof(AWaterZone, OverlapPriority) == 0x000304, "Member 'AWaterZone::OverlapPriority' has a wrong offset!");
static_assert(offsetof(AWaterZone, bEnableNonTessellatedLODMesh) == 0x000308, "Member 'AWaterZone::bEnableNonTessellatedLODMesh' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_169E[0x4];                                     // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_169F[0x18];                                    // 0x0030(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_16A0[0x8];                                     // 0x0558(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULakeCollisionComponent) == 0x000560, "Wrong size on ULakeCollisionComponent");
static_assert(offsetof(ULakeCollisionComponent, CachedBodySetup) == 0x000538, "Member 'ULakeCollisionComponent::CachedBodySetup' has a wrong offset!");
static_assert(offsetof(ULakeCollisionComponent, BoxExtent) == 0x000540, "Member 'ULakeCollisionComponent::BoxExtent' has a wrong offset!");
...
public:
	class UBodySetup*                             CachedBodySetup;                                   // 0x0538(0x0008)(ZeroConstructor, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_16A1[0x40];                                    // 0x0540(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOceanCollisionComponent) == 0x000580, "Wrong size on UOceanCollisionComponent");
static_assert(offsetof(UOceanCollisionComponent, CachedBodySetup) == 0x000538, "Member 'UOceanCollisionComponent::CachedBodySetup' has a wrong offset!");
...
static_assert(sizeof(UOceanBoxCollisionComponent) == 0x000580, "Wrong size on UOceanBoxCollisionComponent");
...
{
public:
	uint8                                         Pad_16A2[0x8];                                     // 0x02A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UWaterSplineComponent*                  SplineComp;                                        // 0x02A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UWaterSplineMetadata*                   WaterSplineMetadata;                               // 0x02B0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UWaterBodyComponent*                    WaterBodyComponent;                                // 0x02B8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         WaterBodyIndex;                                    // 0x02C0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NonTransactional, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EWaterBodyType                                WaterBodyType;                                     // 0x02C4(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_16A3[0x3];                                     // 0x02C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UWaterWavesBase*                        WaterWaves;                                        // 0x02C8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AWaterBody) == 0x0002D0, "Wrong size on AWaterBody");
static_assert(offsetof(AWaterBody, SplineComp) == 0x0002A8, "Member 'AWaterBody::SplineComp' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterSplineMetadata) == 0x0002B0, "Member 'AWaterBody::WaterSplineMetadata' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterBodyComponent) == 0x0002B8, "Member 'AWaterBody::WaterBodyComponent' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterBodyIndex) == 0x0002C0, "Member 'AWaterBody::WaterBodyIndex' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterBodyType) == 0x0002C4, "Member 'AWaterBody::WaterBodyType' has a wrong offset!");
static_assert(offsetof(AWaterBody, WaterWaves) == 0x0002C8, "Member 'AWaterBody::WaterWaves' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyCustom) == 0x0002D0, "Wrong size on AWaterBodyCustom");
...
public:
	...
	uint8                                         Pad_16A5[0x8];                                     // 0x1538(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWaterBodyCustomComponent) == 0x001540, "Wrong size on UWaterBodyCustomComponent");
static_assert(offsetof(UWaterBodyCustomComponent, MeshComp) == 0x001530, "Member 'UWaterBodyCustomComponent::MeshComp' has a wrong offset!");
...
{
public:
	bool                                          bExcludeAllOverlappingWaterBodies;                 // 0x02E8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_16A6[0x7];                                     // 0x02E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AWaterBody*>                     WaterBodiesToExclude;                              // 0x02F0(0x0010)(Edit, ZeroConstructor, DisableEditOnTemplate, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AWaterBodyExclusionVolume) == 0x000300, "Wrong size on AWaterBodyExclusionVolume");
static_assert(offsetof(AWaterBodyExclusionVolume, bExcludeAllOverlappingWaterBodies) == 0x0002E8, "Member 'AWaterBodyExclusionVolume::bExcludeAllOverlappingWaterBodies' has a wrong offset!");
static_assert(offsetof(AWaterBodyExclusionVolume, WaterBodiesToExclude) == 0x0002F0, "Member 'AWaterBodyExclusionVolume::WaterBodiesToExclude' has a wrong offset!");
...
{
public:
	uint8                                         Pad_16A7[0x8];                                     // 0x02A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UWaterSplineComponent*                  SplineComp;                                        // 0x02A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AWaterBodyIsland) == 0x0002B0, "Wrong size on AWaterBodyIsland");
static_assert(offsetof(AWaterBodyIsland, SplineComp) == 0x0002A8, "Member 'AWaterBodyIsland::SplineComp' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyLake) == 0x0002D0, "Wrong size on AWaterBodyLake");
...
{
public:
	class UStaticMeshComponent*                   LakeMeshComp;                                      // 0x1530(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULakeCollisionComponent*                LakeCollision;                                     // 0x1538(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UWaterBodyLakeComponent) == 0x001540, "Wrong size on UWaterBodyLakeComponent");
static_assert(offsetof(UWaterBodyLakeComponent, LakeMeshComp) == 0x001530, "Member 'UWaterBodyLakeComponent::LakeMeshComp' has a wrong offset!");
static_assert(offsetof(UWaterBodyLakeComponent, LakeCollision) == 0x001538, "Member 'UWaterBodyLakeComponent::LakeCollision' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyOcean) == 0x0002D0, "Wrong size on AWaterBodyOcean");
...
{
public:
	TArray<class UOceanBoxCollisionComponent*>    CollisionBoxes;                                    // 0x1530(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NonPIEDuplicateTransient, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UOceanCollisionComponent*>       CollisionHullSets;                                 // 0x1540(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NonPIEDuplicateTransient, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_16A8[0x4];                                     // 0x157C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWaterBodyOceanComponent) == 0x001580, "Wrong size on UWaterBodyOceanComponent");
static_assert(offsetof(UWaterBodyOceanComponent, CollisionBoxes) == 0x001530, "Member 'UWaterBodyOceanComponent::CollisionBoxes' has a wrong offset!");
static_assert(offsetof(UWaterBodyOceanComponent, CollisionHullSets) == 0x001540, "Member 'UWaterBodyOceanComponent::CollisionHullSets' has a wrong offset!");
static_assert(offsetof(UWaterBodyOceanComponent, VisualExtents) == 0x001550, "Member 'UWaterBodyOceanComponent::VisualExtents' has a wrong offset!");
static_assert(offsetof(UWaterBodyOceanComponent, CollisionExtents) == 0x001560, "Member 'UWaterBodyOceanComponent::CollisionExtents' has a wrong offset!");
static_assert(offsetof(UWaterBodyOceanComponent, HeightOffset) == 0x001578, "Member 'UWaterBodyOceanComponent::HeightOffset' has a wrong offset!");
...
static_assert(sizeof(AWaterBodyRiver) == 0x0002D0, "Wrong size on AWaterBodyRiver");
...
{
public:
	TArray<class USplineMeshComponent*>           SplineMeshComponents;                              // 0x1530(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NonPIEDuplicateTransient, UObjectWrapper, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     LakeTransitionMaterial;                            // 0x1540(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               LakeTransitionMID;                                 // 0x1548(0x0008)(Edit, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, NoDestructor, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     OceanTransitionMaterial;                           // 0x1550(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               OceanTransitionMID;                                // 0x1558(0x0008)(Edit, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, NoDestructor, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UWaterBodyRiverComponent) == 0x001560, "Wrong size on UWaterBodyRiverComponent");
static_assert(offsetof(UWaterBodyRiverComponent, SplineMeshComponents) == 0x001530, "Member 'UWaterBodyRiverComponent::SplineMeshComponents' has a wrong offset!");
static_assert(offsetof(UWaterBodyRiverComponent, LakeTransitionMaterial) == 0x001540, "Member 'UWaterBodyRiverComponent::LakeTransitionMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyRiverComponent, LakeTransitionMID) == 0x001548, "Member 'UWaterBodyRiverComponent::LakeTransitionMID' has a wrong offset!");
static_assert(offsetof(UWaterBodyRiverComponent, OceanTransitionMaterial) == 0x001550, "Member 'UWaterBodyRiverComponent::OceanTransitionMaterial' has a wrong offset!");
static_assert(offsetof(UWaterBodyRiverComponent, OceanTransitionMID) == 0x001558, "Member 'UWaterBodyRiverComponent::OceanTransitionMID' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_16A9[0x4];                                     // 0x0574(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16AA[0x98];                                    // 0x0590(0x0098)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16AB[0x10];                                    // 0x0678(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UWaterMeshComponent, ForceCollapseDensityLevel) == 0x000570, "Member 'UWaterMeshComponent::ForceCollapseDensityLevel' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, FarDistanceMaterial) == 0x000578, "Member 'UWaterMeshComponent::FarDistanceMaterial' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, FarDistanceMeshExtent) == 0x000580, "Member 'UWaterMeshComponent::FarDistanceMeshExtent' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, TileSize) == 0x000584, "Member 'UWaterMeshComponent::TileSize' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, ExtentInTiles) == 0x000588, "Member 'UWaterMeshComponent::ExtentInTiles' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, UsedMaterials) == 0x000628, "Member 'UWaterMeshComponent::UsedMaterials' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, TessellationFactor) == 0x000688, "Member 'UWaterMeshComponent::TessellationFactor' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, LODScale) == 0x00068C, "Member 'UWaterMeshComponent::LODScale' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_16AC[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16AD[0x4];                                     // 0x007C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWaterRuntimeSettings) == 0x0000D0, "Wrong size on UWaterRuntimeSettings");
...
static_assert(offsetof(UWaterRuntimeSettings, WaterBodyIconWorldZOffset) == 0x000070, "Member 'UWaterRuntimeSettings::WaterBodyIconWorldZOffset' has a wrong offset!");
static_assert(offsetof(UWaterRuntimeSettings, DefaultWaterCollisionProfileName) == 0x000074, "Member 'UWaterRuntimeSettings::DefaultWaterCollisionProfileName' has a wrong offset!");
static_assert(offsetof(UWaterRuntimeSettings, DefaultWaterInfoMaterial) == 0x000080, "Member 'UWaterRuntimeSettings::DefaultWaterInfoMaterial' has a wrong offset!");
static_assert(offsetof(UWaterRuntimeSettings, WaterBodyRiverComponentClass) == 0x0000B0, "Member 'UWaterRuntimeSettings::WaterBodyRiverComponentClass' has a wrong offset!");
static_assert(offsetof(UWaterRuntimeSettings, WaterBodyLakeComponentClass) == 0x0000B8, "Member 'UWaterRuntimeSettings::WaterBodyLakeComponentClass' has a wrong offset!");
static_assert(offsetof(UWaterRuntimeSettings, WaterBodyOceanComponentClass) == 0x0000C0, "Member 'UWaterRuntimeSettings::WaterBodyOceanComponentClass' has a wrong offset!");
static_assert(offsetof(UWaterRuntimeSettings, WaterBodyCustomComponentClass) == 0x0000C8, "Member 'UWaterRuntimeSettings::WaterBodyCustomComponentClass' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_16AE[0x8];                                     // 0x0658(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWaterSplineComponent) == 0x000660, "Wrong size on UWaterSplineComponent");
static_assert(offsetof(UWaterSplineComponent, WaterSplineDefaults) == 0x000638, "Member 'UWaterSplineComponent::WaterSplineDefaults' has a wrong offset!");
static_assert(offsetof(UWaterSplineComponent, PreviousWaterSplineDefaults) == 0x000648, "Member 'UWaterSplineComponent::PreviousWaterSplineDefaults' has a wrong offset!");
...
{
public:
	uint8                                         Pad_16AF[0x38];                                    // 0x0040(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16B0[0x28];                                    // 0x00B0(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16B1[0x30];                                    // 0x00E0(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
