...
{
public:
	struct FBP_TopBackerSettings_CloseButton      Settings;                                          // 0x0000(0x00A8)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
	ESlateVisibility                              Temp_byte_Variable;                                // 0x00A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4A47[0x7];                                     // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A48[0x7];                                     // 0x00C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_TopBacker_01_CM_C_ApplyBackerSettings) == 0x0000E0, "Wrong size on WBP_TopBacker_01_CM_C_ApplyBackerSettings");
...
static_assert(offsetof(WBP_TopBacker_01_CM_C_ApplyBackerSettings, Temp_byte_Variable) == 0x0000A8, "Member 'WBP_TopBacker_01_CM_C_ApplyBackerSettings::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_TopBacker_01_CM_C_ApplyBackerSettings, CallFunc_SlotAsOverlaySlot_ReturnValue) == 0x0000B0, "Member 'WBP_TopBacker_01_CM_C_ApplyBackerSettings::CallFunc_SlotAsOverlaySlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TopBacker_01_CM_C_ApplyBackerSettings, CallFunc_SlotAsOverlaySlot_ReturnValue_1) == 0x0000B8, "Member 'WBP_TopBacker_01_CM_C_ApplyBackerSettings::CallFunc_SlotAsOverlaySlot_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_TopBacker_01_CM_C_ApplyBackerSettings, Temp_byte_Variable_1) == 0x0000C0, "Member 'WBP_TopBacker_01_CM_C_ApplyBackerSettings::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_TopBacker_01_CM_C_ApplyBackerSettings, CallFunc_SlotAsHorizontalBoxSlot_ReturnValue) == 0x0000C8, "Member 'WBP_TopBacker_01_CM_C_ApplyBackerSettings::CallFunc_SlotAsHorizontalBoxSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TopBacker_01_CM_C_ApplyBackerSettings, CallFunc_SlotAsOverlaySlot_ReturnValue_2) == 0x0000D0, "Member 'WBP_TopBacker_01_CM_C_ApplyBackerSettings::CallFunc_SlotAsOverlaySlot_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_TopBacker_01_CM_C_ApplyBackerSettings, Temp_bool_Variable) == 0x0000D8, "Member 'WBP_TopBacker_01_CM_C_ApplyBackerSettings::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_TopBacker_01_CM_C_ApplyBackerSettings, K2Node_Select_Default) == 0x0000D9, "Member 'WBP_TopBacker_01_CM_C_ApplyBackerSettings::K2Node_Select_Default' has a wrong offset!");
