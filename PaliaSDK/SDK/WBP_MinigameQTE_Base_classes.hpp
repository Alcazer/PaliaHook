...
public:
	...
	class UMinigameComponentMasterQTE*            LinkedMinigame;                                    // 0x0280(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TSoftObjectPtr<class UVAL_TutorialFlagDefinition> FTUEFlag;                                          // 0x0288(0x0030)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TSoftClassPtr<class UClass>                   TutorialWidget;                                    // 0x02B8(0x0030)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	bool                                          StartMinigameOnLink;                               // 0x02E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          FTUE_IsOpen;                                       // 0x02E9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4493[0x2];                                     // 0x02EA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMargin                                StandardPadding;                                   // 0x02EC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FMargin                                CinematicCameraPadding;                            // 0x02FC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(UWBP_MinigameQTE_Base_C) == 0x000310, "Wrong size on UWBP_MinigameQTE_Base_C");
static_assert(offsetof(UWBP_MinigameQTE_Base_C, UberGraphFrame) == 0x000278, "Member 'UWBP_MinigameQTE_Base_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_MinigameQTE_Base_C, LinkedMinigame) == 0x000280, "Member 'UWBP_MinigameQTE_Base_C::LinkedMinigame' has a wrong offset!");
static_assert(offsetof(UWBP_MinigameQTE_Base_C, FTUEFlag) == 0x000288, "Member 'UWBP_MinigameQTE_Base_C::FTUEFlag' has a wrong offset!");
static_assert(offsetof(UWBP_MinigameQTE_Base_C, TutorialWidget) == 0x0002B8, "Member 'UWBP_MinigameQTE_Base_C::TutorialWidget' has a wrong offset!");
static_assert(offsetof(UWBP_MinigameQTE_Base_C, StartMinigameOnLink) == 0x0002E8, "Member 'UWBP_MinigameQTE_Base_C::StartMinigameOnLink' has a wrong offset!");
static_assert(offsetof(UWBP_MinigameQTE_Base_C, FTUE_IsOpen) == 0x0002E9, "Member 'UWBP_MinigameQTE_Base_C::FTUE_IsOpen' has a wrong offset!");
static_assert(offsetof(UWBP_MinigameQTE_Base_C, StandardPadding) == 0x0002EC, "Member 'UWBP_MinigameQTE_Base_C::StandardPadding' has a wrong offset!");
static_assert(offsetof(UWBP_MinigameQTE_Base_C, CinematicCameraPadding) == 0x0002FC, "Member 'UWBP_MinigameQTE_Base_C::CinematicCameraPadding' has a wrong offset!");
