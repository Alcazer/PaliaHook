...
public:
	...
	uint8                                         Pad_18C9[0x5];                                     // 0x003B(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18CA[0x6];                                     // 0x0042(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCommonUIInputData) == 0x000058, "Wrong size on UCommonUIInputData");
...
static_assert(offsetof(UCommonUIInputData, EnhancedInputClickAction) == 0x000048, "Member 'UCommonUIInputData::EnhancedInputClickAction' has a wrong offset!");
static_assert(offsetof(UCommonUIInputData, EnhancedInputBackAction) == 0x000050, "Member 'UCommonUIInputData::EnhancedInputBackAction' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_18CB[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18CC[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18CD[0x3];                                     // 0x004D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18CE[0x3];                                     // 0x00C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18CF[0x5];                                     // 0x00E3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18D0[0x8];                                     // 0x0118(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UCommonInputSettings, bEnableEnhancedInputSupport) == 0x0000E2, "Member 'UCommonInputSettings::bEnableEnhancedInputSupport' has a wrong offset!");
...
{
public:
	uint8                                         Pad_18D1[0x40];                                    // 0x0030(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18D2[0x4];                                     // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18D3[0x2];                                     // 0x009A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   GamepadInputType;                                  // 0x009C(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_18D4[0x4];                                     // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, ECommonInputType>           CurrentInputLocks;                                 // 0x00A8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_18D5[0x18];                                    // 0x00F8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonInputActionDomainTable*          ActionDomainTable;                                 // 0x0110(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsGamepadSimulatedClick;                          // 0x0118(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_18D6[0x17];                                    // 0x0119(0x0017)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCommonInputSubsystem) == 0x000130, "Wrong size on UCommonInputSubsystem");
...
static_assert(offsetof(UCommonInputSubsystem, ActionDomainTable) == 0x000110, "Member 'UCommonInputSubsystem::ActionDomainTable' has a wrong offset!");
static_assert(offsetof(UCommonInputSubsystem, bIsGamepadSimulatedClick) == 0x000118, "Member 'UCommonInputSubsystem::bIsGamepadSimulatedClick' has a wrong offset!");
