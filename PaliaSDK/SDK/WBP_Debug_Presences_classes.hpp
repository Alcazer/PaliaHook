...
public:
	...
	class UVALUI_ListView_Styled*                 ListView;                                          // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	bool                                          WaitingToRefresh;                                  // 0x0288(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4C58[0x7];                                     // 0x0289(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        RefreshInterval;                                   // 0x0290(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Debug_Presences_C) == 0x000298, "Wrong size on UWBP_Debug_Presences_C");
static_assert(offsetof(UWBP_Debug_Presences_C, UberGraphFrame) == 0x000278, "Member 'UWBP_Debug_Presences_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Debug_Presences_C, ListView) == 0x000280, "Member 'UWBP_Debug_Presences_C::ListView' has a wrong offset!");
static_assert(offsetof(UWBP_Debug_Presences_C, WaitingToRefresh) == 0x000288, "Member 'UWBP_Debug_Presences_C::WaitingToRefresh' has a wrong offset!");
static_assert(offsetof(UWBP_Debug_Presences_C, RefreshInterval) == 0x000290, "Member 'UWBP_Debug_Presences_C::RefreshInterval' has a wrong offset!");
