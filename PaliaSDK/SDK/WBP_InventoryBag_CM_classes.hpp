...
public:
	...
	class USizeBox*                               ActionBarIndexSizeBox;                             // 0x02A8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_Border_Styled*                   Border_ActionBar;                                  // 0x02B0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_TextBlock_Styled*                InventoryOverflowing_TextBlock;                    // 0x02B8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_Border_Styled*                   InventoryOverflowingAnchor;                        // 0x02C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class USizeBox*                               SizeBox_Bag;                                       // 0x02C8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_TextBlock_Styled*                Text_ActionBarIndex;                               // 0x02D0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UUniformGridPanel*                      UGrid_Slots;                                       // 0x02D8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UInventoryComponent*                    Inventory;                                         // 0x02E0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	int32                                         LocalBagIndex;                                     // 0x02E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	int32                                         BagIndex;                                          // 0x02EC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	class UClass*                                 SlotType;                                          // 0x02F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnSlotLeftClicked;                                 // 0x02F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnSlotRightClicked;                                // 0x0308(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	int32                                         MaxSlotsPerRow;                                    // 0x0318(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	bool                                          bSlotsDraggable;                                   // 0x031C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	uint8                                         Pad_51FA[0x3];                                     // 0x031D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMargin                                Slot_Padding;                                      // 0x0320(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	FMulticastInlineDelegateProperty_             OnSlotGamepadSelect;                               // 0x0330(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnSlotGamepadCancel;                               // 0x0340(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	class UWBP_InventorySlot_CM_C*                FirstInventorySlot;                                // 0x0370(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          HideActionBarIndex;                                // 0x0379(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	uint8                                         Pad_51FB[0x6];                                     // 0x037A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<EVALUI_UISize, double>                   InventorySlotSideMarginSizeMap;                    // 0x0380(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<EVALUI_UISize, struct FMargin>           GridOverlayBaseMarginSizeMap;                      // 0x03D0(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(UWBP_InventoryBag_CM_C) == 0x000420, "Wrong size on UWBP_InventoryBag_CM_C");
static_assert(offsetof(UWBP_InventoryBag_CM_C, UberGraphFrame) == 0x0002A0, "Member 'UWBP_InventoryBag_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, ActionBarIndexSizeBox) == 0x0002A8, "Member 'UWBP_InventoryBag_CM_C::ActionBarIndexSizeBox' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, Border_ActionBar) == 0x0002B0, "Member 'UWBP_InventoryBag_CM_C::Border_ActionBar' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, InventoryOverflowing_TextBlock) == 0x0002B8, "Member 'UWBP_InventoryBag_CM_C::InventoryOverflowing_TextBlock' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, InventoryOverflowingAnchor) == 0x0002C0, "Member 'UWBP_InventoryBag_CM_C::InventoryOverflowingAnchor' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, SizeBox_Bag) == 0x0002C8, "Member 'UWBP_InventoryBag_CM_C::SizeBox_Bag' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, Text_ActionBarIndex) == 0x0002D0, "Member 'UWBP_InventoryBag_CM_C::Text_ActionBarIndex' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, UGrid_Slots) == 0x0002D8, "Member 'UWBP_InventoryBag_CM_C::UGrid_Slots' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, Inventory) == 0x0002E0, "Member 'UWBP_InventoryBag_CM_C::Inventory' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, LocalBagIndex) == 0x0002E8, "Member 'UWBP_InventoryBag_CM_C::LocalBagIndex' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, BagIndex) == 0x0002EC, "Member 'UWBP_InventoryBag_CM_C::BagIndex' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, SlotType) == 0x0002F0, "Member 'UWBP_InventoryBag_CM_C::SlotType' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, OnSlotLeftClicked) == 0x0002F8, "Member 'UWBP_InventoryBag_CM_C::OnSlotLeftClicked' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, OnSlotRightClicked) == 0x000308, "Member 'UWBP_InventoryBag_CM_C::OnSlotRightClicked' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, MaxSlotsPerRow) == 0x000318, "Member 'UWBP_InventoryBag_CM_C::MaxSlotsPerRow' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, bSlotsDraggable) == 0x00031C, "Member 'UWBP_InventoryBag_CM_C::bSlotsDraggable' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, Slot_Padding) == 0x000320, "Member 'UWBP_InventoryBag_CM_C::Slot_Padding' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, OnSlotGamepadSelect) == 0x000330, "Member 'UWBP_InventoryBag_CM_C::OnSlotGamepadSelect' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, OnSlotGamepadCancel) == 0x000340, "Member 'UWBP_InventoryBag_CM_C::OnSlotGamepadCancel' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, OnOpenActionMenu) == 0x000350, "Member 'UWBP_InventoryBag_CM_C::OnOpenActionMenu' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, OnSlotFocused) == 0x000360, "Member 'UWBP_InventoryBag_CM_C::OnSlotFocused' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, FirstInventorySlot) == 0x000370, "Member 'UWBP_InventoryBag_CM_C::FirstInventorySlot' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, UiSize) == 0x000378, "Member 'UWBP_InventoryBag_CM_C::UiSize' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, HideActionBarIndex) == 0x000379, "Member 'UWBP_InventoryBag_CM_C::HideActionBarIndex' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, InventorySlotSideMarginSizeMap) == 0x000380, "Member 'UWBP_InventoryBag_CM_C::InventorySlotSideMarginSizeMap' has a wrong offset!");
static_assert(offsetof(UWBP_InventoryBag_CM_C, GridOverlayBaseMarginSizeMap) == 0x0003D0, "Member 'UWBP_InventoryBag_CM_C::GridOverlayBaseMarginSizeMap' has a wrong offset!");
