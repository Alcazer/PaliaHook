...
public:
	...
	class UVALUI_Button_Styled*                   Button_A;                                          // 0x04F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_Button_Styled*                   Button_Close;                                      // 0x0500(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_BoundInputActionStateIndicator_C*  WBP_BoundInputActionStateIndicator;                // 0x0508(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_BoundInputActionStateIndicator_C*  WBP_BoundInputActionStateIndicator_210;            // 0x0510(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FGuid                                  Notification_Id;                                   // 0x0518(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Notification_DebugTest_WithBindings_C) == 0x000530, "Wrong size on UWBP_Notification_DebugTest_WithBindings_C");
static_assert(offsetof(UWBP_Notification_DebugTest_WithBindings_C, UberGraphFrame) == 0x0004F0, "Member 'UWBP_Notification_DebugTest_WithBindings_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_DebugTest_WithBindings_C, Button_A) == 0x0004F8, "Member 'UWBP_Notification_DebugTest_WithBindings_C::Button_A' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_DebugTest_WithBindings_C, Button_Close) == 0x000500, "Member 'UWBP_Notification_DebugTest_WithBindings_C::Button_Close' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_DebugTest_WithBindings_C, WBP_BoundInputActionStateIndicator) == 0x000508, "Member 'UWBP_Notification_DebugTest_WithBindings_C::WBP_BoundInputActionStateIndicator' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_DebugTest_WithBindings_C, WBP_BoundInputActionStateIndicator_210) == 0x000510, "Member 'UWBP_Notification_DebugTest_WithBindings_C::WBP_BoundInputActionStateIndicator_210' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_DebugTest_WithBindings_C, Notification_Id) == 0x000518, "Member 'UWBP_Notification_DebugTest_WithBindings_C::Notification_Id' has a wrong offset!");
static_assert(offsetof(UWBP_Notification_DebugTest_WithBindings_C, Notification_Queue) == 0x000528, "Member 'UWBP_Notification_DebugTest_WithBindings_C::Notification_Queue' has a wrong offset!");
