...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_CharacterPlateWidgetComponent_C; // 0x0958(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class AValeriaCharacter*                      CurrentCharacter;                                  // 0x0960(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UBP_CharacterPlateWidgetComponent_C) == 0x000970, "Wrong size on UBP_CharacterPlateWidgetComponent_C");
static_assert(offsetof(UBP_CharacterPlateWidgetComponent_C, UberGraphFrame_BP_CharacterPlateWidgetComponent_C) == 0x000958, "Member 'UBP_CharacterPlateWidgetComponent_C::UberGraphFrame_BP_CharacterPlateWidgetComponent_C' has a wrong offset!");
static_assert(offsetof(UBP_CharacterPlateWidgetComponent_C, CurrentCharacter) == 0x000960, "Member 'UBP_CharacterPlateWidgetComponent_C::CurrentCharacter' has a wrong offset!");
