...
void ABP_FishingSafeArea_C::HandleFishLost(class UFishingViewComponent* FishingView, float CallFunc_GetSafeZoneLength_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, const struct FVector& CallFunc_Conv_FloatToVector_ReturnValue, double CallFunc_Multiply_DoubleDouble_A_ImplicitCast, float CallFunc_Conv_FloatToVector_InFloat_ImplicitCast)
{
	static class UFunction* Func = nullptr;
