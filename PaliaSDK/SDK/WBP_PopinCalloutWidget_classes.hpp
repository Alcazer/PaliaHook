...
public:
	...
	class UVALUI_Border_Styled*                   Border_Root;                                       // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 Image_PointerToAnchor;                             // 0x0288(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UNamedSlot*                             NamedSlot_Content;                                 // 0x0290(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOverlay*                               Overlay_Root;                                      // 0x0298(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	EMenuPlacement                                MenuAnchorPlacement;                               // 0x02A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_PopinCalloutWidget_C) == 0x0002A8, "Wrong size on UWBP_PopinCalloutWidget_C");
static_assert(offsetof(UWBP_PopinCalloutWidget_C, UberGraphFrame) == 0x000278, "Member 'UWBP_PopinCalloutWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_PopinCalloutWidget_C, Border_Root) == 0x000280, "Member 'UWBP_PopinCalloutWidget_C::Border_Root' has a wrong offset!");
static_assert(offsetof(UWBP_PopinCalloutWidget_C, Image_PointerToAnchor) == 0x000288, "Member 'UWBP_PopinCalloutWidget_C::Image_PointerToAnchor' has a wrong offset!");
static_assert(offsetof(UWBP_PopinCalloutWidget_C, NamedSlot_Content) == 0x000290, "Member 'UWBP_PopinCalloutWidget_C::NamedSlot_Content' has a wrong offset!");
static_assert(offsetof(UWBP_PopinCalloutWidget_C, Overlay_Root) == 0x000298, "Member 'UWBP_PopinCalloutWidget_C::Overlay_Root' has a wrong offset!");
static_assert(offsetof(UWBP_PopinCalloutWidget_C, MenuAnchorPlacement) == 0x0002A0, "Member 'UWBP_PopinCalloutWidget_C::MenuAnchorPlacement' has a wrong offset!");
