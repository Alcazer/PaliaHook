...
public:
	...
	class USizeBox*                               SizeBox_TurntableArea;                             // 0x02A8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnMouseDragged;                                    // 0x02B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	double                                        MouseDragYawRate;                                  // 0x02C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	bool                                          Enabled;                                           // 0x02C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Turntable_C) == 0x0002D0, "Wrong size on UWBP_Turntable_C");
static_assert(offsetof(UWBP_Turntable_C, UberGraphFrame) == 0x0002A0, "Member 'UWBP_Turntable_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Turntable_C, SizeBox_TurntableArea) == 0x0002A8, "Member 'UWBP_Turntable_C::SizeBox_TurntableArea' has a wrong offset!");
static_assert(offsetof(UWBP_Turntable_C, OnMouseDragged) == 0x0002B0, "Member 'UWBP_Turntable_C::OnMouseDragged' has a wrong offset!");
static_assert(offsetof(UWBP_Turntable_C, MouseDragYawRate) == 0x0002C0, "Member 'UWBP_Turntable_C::MouseDragYawRate' has a wrong offset!");
static_assert(offsetof(UWBP_Turntable_C, Enabled) == 0x0002C8, "Member 'UWBP_Turntable_C::Enabled' has a wrong offset!");
