...
// double                                  K2Node_VariableSet_MidRangeFloor_ImplicitCast          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_InteractPlate_Prompt_C::Update_Alignment(const TArray<class UWidget*>& Prompts, int32 CurrentIndex, double MidRange, double MidRangeFloor, int32 CalculatedMaxStepRange, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Variable, class UWidget* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_IsVisible_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_GetChildrenCount_ReturnValue, int32 CallFunc_Max_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue_1, float CallFunc_Conv_IntToFloat_ReturnValue_1, int32 CallFunc_FFloor_ReturnValue, double CallFunc_Subtract_DoubleDouble_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue_2, double CallFunc_Multiply_DoubleDouble_ReturnValue, double CallFunc_Subtract_DoubleDouble_ReturnValue_1, double CallFunc_Abs_ReturnValue, TArray<class UWidget*>& CallFunc_GetAllChildren_ReturnValue, double CallFunc_Subtract_DoubleDouble_ReturnValue_2, double CallFunc_FMin_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_1, const struct FVector2D& CallFunc_MakeVector2D_ReturnValue, double CallFunc_Multiply_IntFloat_ReturnValue, int32 CallFunc_FTrunc_ReturnValue, double CallFunc_Subtract_DoubleDouble_A_ImplicitCast, double CallFunc_Subtract_DoubleDouble_A_ImplicitCast_1, double K2Node_VariableSet_MidRangeFloor_ImplicitCast)
{
	...
	Parms.K2Node_VariableSet_MidRangeFloor_ImplicitCast = K2Node_VariableSet_MidRangeFloor_ImplicitCast;
