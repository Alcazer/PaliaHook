...
// TDelegate<void(class UFishingViewComponent* FishingView, EFishingNibbleLevel Nibble, class UFishingComponent* Source, int32 FishNumber)>K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UABP_FishingRod_C::OnNibbled_Event_0(class UFishingViewComponent* FishingView, EFishingNibbleLevel Nibble, class UFishingComponent* Source, int32 FishNumber)
{
	static class UFunction* Func = nullptr;
