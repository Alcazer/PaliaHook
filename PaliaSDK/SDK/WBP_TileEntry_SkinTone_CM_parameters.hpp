...
public:
	...
	uint8                                         Pad_4E1B[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E1C[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E1D[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E1E[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E1F[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVAL_CharacterCustomizationItem_SkinTone_PerBodyTypeConfig CallFunc_TryGetBodyTypeSpecificConfig_SkinTone_OutBodyTypeSpecificConfig; // 0x0068(0x0100)()
	bool                                          CallFunc_TryGetBodyTypeSpecificConfig_SkinTone_ReturnValue; // 0x0168(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4E20[0x3];                                     // 0x0169(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class UObject* Loaded)>        K2Node_CreateDelegate_OutputDelegate;              // 0x016C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4E21[0x4];                                     // 0x017C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_Template_Button_ColorPicker_01_CM_C* K2Node_ComponentBoundEvent_Button;                 // 0x0180(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_TileEntry_SkinTone_CM_C_ExecuteUbergraph_WBP_TileEntry_SkinTone_CM) == 0x000190, "Wrong size on WBP_TileEntry_SkinTone_CM_C_ExecuteUbergraph_WBP_TileEntry_SkinTone_CM");
...
static_assert(offsetof(WBP_TileEntry_SkinTone_CM_C_ExecuteUbergraph_WBP_TileEntry_SkinTone_CM, CallFunc_TryGetBodyTypeSpecificConfig_SkinTone_ReturnValue) == 0x000168, "Member 'WBP_TileEntry_SkinTone_CM_C_ExecuteUbergraph_WBP_TileEntry_SkinTone_CM::CallFunc_TryGetBodyTypeSpecificConfig_SkinTone_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TileEntry_SkinTone_CM_C_ExecuteUbergraph_WBP_TileEntry_SkinTone_CM, K2Node_CreateDelegate_OutputDelegate) == 0x00016C, "Member 'WBP_TileEntry_SkinTone_CM_C_ExecuteUbergraph_WBP_TileEntry_SkinTone_CM::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_TileEntry_SkinTone_CM_C_ExecuteUbergraph_WBP_TileEntry_SkinTone_CM, K2Node_ComponentBoundEvent_Button) == 0x000180, "Member 'WBP_TileEntry_SkinTone_CM_C_ExecuteUbergraph_WBP_TileEntry_SkinTone_CM::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(WBP_TileEntry_SkinTone_CM_C_ExecuteUbergraph_WBP_TileEntry_SkinTone_CM, K2Node_Event_InFocusEvent) == 0x000188, "Member 'WBP_TileEntry_SkinTone_CM_C_ExecuteUbergraph_WBP_TileEntry_SkinTone_CM::K2Node_Event_InFocusEvent' has a wrong offset!");
...
static_assert(sizeof(WBP_TileEntry_SkinTone_CM_C_OnFocusReceived) == 0x0001B8, "Wrong size on WBP_TileEntry_SkinTone_CM_C_OnFocusReceived");
...
static_assert(offsetof(WBP_TileEntry_SkinTone_CM_C_OnFocusReceived, InFocusEvent) == 0x000040, "Member 'WBP_TileEntry_SkinTone_CM_C_OnFocusReceived::InFocusEvent' has a wrong offset!");
static_assert(offsetof(WBP_TileEntry_SkinTone_CM_C_OnFocusReceived, ReturnValue) == 0x000048, "Member 'WBP_TileEntry_SkinTone_CM_C_OnFocusReceived::ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_TileEntry_SkinTone_CM_C_OnFocusReceived, CallFunc_Handled_ReturnValue) == 0x000100, "Member 'WBP_TileEntry_SkinTone_CM_C_OnFocusReceived::CallFunc_Handled_ReturnValue' has a wrong offset!");
