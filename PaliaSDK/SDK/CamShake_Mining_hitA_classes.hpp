...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"CamShake_Mining_hitA_C">();
	}
	static class UCamShake_Mining_hitA_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCamShake_Mining_hitA_C>();
	}
};
