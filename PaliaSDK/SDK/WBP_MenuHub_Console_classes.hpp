...
public:
	...
	class UWidgetAnimation*                       OpenAnim;                                          // 0x0530(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, RepSkip, NoDestructor, HasGetValueTypeHash)
	class UCommonTileView*                        HousingMenusTileGroup;                             // 0x0538(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVerticalBox*                           MenuHub;                                           // 0x0540(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTileView*                        OtherMenusTileGroup;                               // 0x0548(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVerticalBox*                           Panel_HousingPlot;                                 // 0x0550(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVerticalBox*                           Panel_OtherMenus;                                  // 0x0558(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVerticalBox*                           Panel_PlayerMenus;                                 // 0x0560(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVerticalBox*                           Panel_SocialMenu;                                  // 0x0568(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTileView*                        PlayerMenusTileGroup;                              // 0x0570(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonHierarchicalScrollBox*           ScrollBox;                                         // 0x0578(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTileView*                        SocialMenusTileGroup;                              // 0x0580(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTileView*                        StoreMenusTileGroup;                               // 0x0588(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UWBP_ServerRegion_C*                    WBP_ServerRegion;                                  // 0x0598(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TArray<struct FMenuHubListEntryStruct>        Data_PlayerMenus;                                  // 0x05A0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	TArray<struct FMenuHubListEntryStruct>        Data_SocialMenus;                                  // 0x05B0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	TArray<struct FMenuHubListEntryStruct>        Data_HousingPlotMenus;                             // 0x05C0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	TArray<struct FMenuHubListEntryStruct>        Data_StoreMenus;                                   // 0x05D0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	TArray<struct FMenuHubListEntryStruct>        Data_OtherMenus;                                   // 0x05E0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	class UWidget*                                NavLeftFocus;                                      // 0x05F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	int32                                         NumTileViewColumns;                                // 0x05F8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bNewScreenOpening;                                 // 0x05FC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void BndEvt__WBP_MenuHub_Console_PlayerMenusTileGroup_K2Node_ComponentBoundEvent_1_OnListEntryGeneratedDynamic__DelegateSignature(class UUserWidget* Widget);
	...
	void ExecuteUbergraph_WBP_MenuHub_Console(int32 EntryPoint, const struct FInputActionValue& K2Node_EnhancedInputActionEvent_ActionValue, float K2Node_EnhancedInputActionEvent_ElapsedTime, float K2Node_EnhancedInputActionEvent_TriggeredTime, class UInputAction* K2Node_EnhancedInputActionEvent_SourceAction, class UInputAction* Temp_object_Variable, bool CallFunc_Conv_InputActionValueToBool_ReturnValue, double Temp_real_Variable, double Temp_real_Variable_1, double Temp_real_Variable_0, double Temp_real_Variable_1_0, bool Temp_bool_Variable, TDelegate<void(class UBP_ListEntry_MenuHub_C* EntryData)> K2Node_CreateDelegate_OutputDelegate, class UObject* K2Node_ComponentBoundEvent_Item_8, bool K2Node_ComponentBoundEvent_bIsSelected_3, class UObject* K2Node_ComponentBoundEvent_Item_7, class UUserWidget* K2Node_ComponentBoundEvent_Widget_5, class UObject* K2Node_ComponentBoundEvent_Item_6, bool K2Node_ComponentBoundEvent_bIsSelected_2, class UWBP_MenuHubItem_Console_C* K2Node_DynamicCast_AsWBP_Menu_Hub_Item_Console, bool K2Node_DynamicCast_bSuccess, class UObject* K2Node_ComponentBoundEvent_Item_5, class UUserWidget* K2Node_ComponentBoundEvent_Widget_4, class UObject* K2Node_ComponentBoundEvent_Item_4, bool K2Node_ComponentBoundEvent_bIsSelected_1, class UWBP_MenuHubItem_Console_C* K2Node_DynamicCast_AsWBP_Menu_Hub_Item_Console_1, bool K2Node_DynamicCast_bSuccess_1, class UObject* K2Node_ComponentBoundEvent_Item_3, class UUserWidget* K2Node_ComponentBoundEvent_Widget_3, class UWBP_MenuHubItem_Console_C* K2Node_DynamicCast_AsWBP_Menu_Hub_Item_Console_2, bool K2Node_DynamicCast_bSuccess_2, TDelegate<void(class UBP_ListEntry_MenuHub_C* EntryData)> K2Node_CreateDelegate_OutputDelegate_1, TDelegate<void(class UBP_ListEntry_MenuHub_C* EntryData)> K2Node_CreateDelegate_OutputDelegate_2, TDelegate<void(class UBP_ListEntry_MenuHub_C* EntryData)> K2Node_CreateDelegate_OutputDelegate_3, class UObject* K2Node_ComponentBoundEvent_Item_2, class UUserWidget* K2Node_ComponentBoundEvent_Widget_2, class UWBP_MenuHubItem_Console_C* K2Node_DynamicCast_AsWBP_Menu_Hub_Item_Console_3, bool K2Node_DynamicCast_bSuccess_3, class UObject* K2Node_ComponentBoundEvent_Item_1, class UUserWidget* K2Node_ComponentBoundEvent_Widget_1, class UWBP_MenuHubItem_Console_C* K2Node_DynamicCast_AsWBP_Menu_Hub_Item_Console_4, bool K2Node_DynamicCast_bSuccess_4, class UObject* K2Node_ComponentBoundEvent_Item, bool K2Node_ComponentBoundEvent_bIsSelected, TDelegate<void(class UBP_ListEntry_MenuHub_C* EntryData)> K2Node_CreateDelegate_OutputDelegate_4, int32 CallFunc_AkEventGlobal_ReturnValue, int32 CallFunc_AkEventGlobal_ReturnValue_1, EValeriaFuncResult CallFunc_GetValeriaPlayerController_OutResult, class AValeriaPlayerController* CallFunc_GetValeriaPlayerController_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class US6UI_UIManagerWidgetBase* CallFunc_GetUIManagerWidget_ReturnValue, TDelegate<void(class UWidget* ReadyWidget)> K2Node_CreateDelegate_OutputDelegate_5, class UUserWidget* K2Node_ComponentBoundEvent_Widget, struct FGeometry& CallFunc_GetPaintSpaceGeometry_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, const struct FVector2D& CallFunc_GetLocalSize_ReturnValue, double CallFunc_BreakVector2D_X, double CallFunc_BreakVector2D_Y, float CallFunc_GetEntryWidth_ReturnValue, double CallFunc_Divide_DoubleDouble_ReturnValue, int32 CallFunc_FFloor_ReturnValue, int32 CallFunc_Max_ReturnValue, double CallFunc_Divide_DoubleDouble_B_ImplicitCast);
	...
	void OtherMenuButtonPressed(class UBP_ListEntry_MenuHub_C* EntryData, EMenuHubOtherMenuType Temp_byte_Variable, class UClass* Temp_class_Variable, class UClass* Temp_class_Variable_1, class UClass* Temp_class_Variable_2, class UClass* Temp_class_Variable_3, class UClass* Temp_class_Variable_4, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, bool CallFunc_NotEqual_ByteByte_ReturnValue, class US6UI_UIManagerWidgetBase* CallFunc_GetUIManagerWidget_ReturnValue, class UClass* K2Node_Select_Default, class UUserWidget* CallFunc_Create_ReturnValue);
	...
	void SocialMenuButtonPressed(class UBP_ListEntry_MenuHub_C* EntryData, class FName TabName, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue, EValeriaFuncResult CallFunc_GetValeriaPlayerController_OutResult, class AValeriaPlayerController* CallFunc_GetValeriaPlayerController_ReturnValue, class US6UI_UIManagerWidgetBase* CallFunc_GetUIManagerWidget_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, class UWBP_MainWidget_Console_C* K2Node_DynamicCast_AsWBP_Main_Widget_Console, bool K2Node_DynamicCast_bSuccess);
...
static_assert(sizeof(UWBP_MenuHub_Console_C) == 0x000600, "Wrong size on UWBP_MenuHub_Console_C");
static_assert(offsetof(UWBP_MenuHub_Console_C, UberGraphFrame) == 0x000528, "Member 'UWBP_MenuHub_Console_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, OpenAnim) == 0x000530, "Member 'UWBP_MenuHub_Console_C::OpenAnim' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, HousingMenusTileGroup) == 0x000538, "Member 'UWBP_MenuHub_Console_C::HousingMenusTileGroup' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, MenuHub) == 0x000540, "Member 'UWBP_MenuHub_Console_C::MenuHub' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, OtherMenusTileGroup) == 0x000548, "Member 'UWBP_MenuHub_Console_C::OtherMenusTileGroup' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, Panel_HousingPlot) == 0x000550, "Member 'UWBP_MenuHub_Console_C::Panel_HousingPlot' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, Panel_OtherMenus) == 0x000558, "Member 'UWBP_MenuHub_Console_C::Panel_OtherMenus' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, Panel_PlayerMenus) == 0x000560, "Member 'UWBP_MenuHub_Console_C::Panel_PlayerMenus' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, Panel_SocialMenu) == 0x000568, "Member 'UWBP_MenuHub_Console_C::Panel_SocialMenu' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, PlayerMenusTileGroup) == 0x000570, "Member 'UWBP_MenuHub_Console_C::PlayerMenusTileGroup' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, ScrollBox) == 0x000578, "Member 'UWBP_MenuHub_Console_C::ScrollBox' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, SocialMenusTileGroup) == 0x000580, "Member 'UWBP_MenuHub_Console_C::SocialMenusTileGroup' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, StoreMenusTileGroup) == 0x000588, "Member 'UWBP_MenuHub_Console_C::StoreMenusTileGroup' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, WBP_CommonUIButtonPrompt) == 0x000590, "Member 'UWBP_MenuHub_Console_C::WBP_CommonUIButtonPrompt' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, WBP_ServerRegion) == 0x000598, "Member 'UWBP_MenuHub_Console_C::WBP_ServerRegion' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, Data_PlayerMenus) == 0x0005A0, "Member 'UWBP_MenuHub_Console_C::Data_PlayerMenus' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, Data_SocialMenus) == 0x0005B0, "Member 'UWBP_MenuHub_Console_C::Data_SocialMenus' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, Data_HousingPlotMenus) == 0x0005C0, "Member 'UWBP_MenuHub_Console_C::Data_HousingPlotMenus' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, Data_StoreMenus) == 0x0005D0, "Member 'UWBP_MenuHub_Console_C::Data_StoreMenus' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, Data_OtherMenus) == 0x0005E0, "Member 'UWBP_MenuHub_Console_C::Data_OtherMenus' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, NavLeftFocus) == 0x0005F0, "Member 'UWBP_MenuHub_Console_C::NavLeftFocus' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, NumTileViewColumns) == 0x0005F8, "Member 'UWBP_MenuHub_Console_C::NumTileViewColumns' has a wrong offset!");
static_assert(offsetof(UWBP_MenuHub_Console_C, bNewScreenOpening) == 0x0005FC, "Member 'UWBP_MenuHub_Console_C::bNewScreenOpening' has a wrong offset!");
