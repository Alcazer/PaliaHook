...
static_assert(sizeof(UWBP_PopupResetDefault_KeyRebind_PF_C) == 0x000598, "Wrong size on UWBP_PopupResetDefault_KeyRebind_PF_C");
static_assert(offsetof(UWBP_PopupResetDefault_KeyRebind_PF_C, UberGraphFrame) == 0x000558, "Member 'UWBP_PopupResetDefault_KeyRebind_PF_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_PopupResetDefault_KeyRebind_PF_C, DefaultSettings) == 0x000560, "Member 'UWBP_PopupResetDefault_KeyRebind_PF_C::DefaultSettings' has a wrong offset!");
static_assert(offsetof(UWBP_PopupResetDefault_KeyRebind_PF_C, OnConfirm) == 0x000568, "Member 'UWBP_PopupResetDefault_KeyRebind_PF_C::OnConfirm' has a wrong offset!");
static_assert(offsetof(UWBP_PopupResetDefault_KeyRebind_PF_C, OnCancel) == 0x000578, "Member 'UWBP_PopupResetDefault_KeyRebind_PF_C::OnCancel' has a wrong offset!");
static_assert(offsetof(UWBP_PopupResetDefault_KeyRebind_PF_C, OnClose) == 0x000588, "Member 'UWBP_PopupResetDefault_KeyRebind_PF_C::OnClose' has a wrong offset!");
