...
{
public:
	uint8                                         Pad_3809[0x20];                                    // 0x0098(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_380A[0x10];                                    // 0x0060(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_380B[0x7];                                     // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
