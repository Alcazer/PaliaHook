...
public:
	...
	class UWBP_SettingsItem_Checkbox_CM_C*        Checkmark_MuteInBackground;                        // 0x04F0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_SettingsItem_Dropdown_CM_C*        ComboBox_MixProfile;                               // 0x04F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_SettingsItem_Dropdown_CM_C*        ComboBox_PanningRule;                              // 0x0500(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_SettingsItem_Slider_CM_C*          Slider_DialogueVolume;                             // 0x0508(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_SettingsItem_Slider_CM_C*          Slider_MusicVolume;                                // 0x0510(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_SettingsItem_Slider_CM_C*          Slider_OverallVolume;                              // 0x0518(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_SettingsItem_Slider_CM_C*          Slider_SFXVolume;                                  // 0x0520(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_ScrollBox_Styled*                VALUI_ScrollBox_Styled_175;                        // 0x0528(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Settings_DescriptionBox_C*         WBP_Settings_DescriptionBox;                       // 0x0530(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	int32                                         AkMusID;                                           // 0x0538(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bIsSynced;                                         // 0x053C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Audio_Settings_CM_C) == 0x000540, "Wrong size on UWBP_Audio_Settings_CM_C");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, UberGraphFrame) == 0x0004E0, "Member 'UWBP_Audio_Settings_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, Button_Secondary_ResetToDefault_CM) == 0x0004E8, "Member 'UWBP_Audio_Settings_CM_C::Button_Secondary_ResetToDefault_CM' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, Checkmark_MuteInBackground) == 0x0004F0, "Member 'UWBP_Audio_Settings_CM_C::Checkmark_MuteInBackground' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, ComboBox_MixProfile) == 0x0004F8, "Member 'UWBP_Audio_Settings_CM_C::ComboBox_MixProfile' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, ComboBox_PanningRule) == 0x000500, "Member 'UWBP_Audio_Settings_CM_C::ComboBox_PanningRule' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, Slider_DialogueVolume) == 0x000508, "Member 'UWBP_Audio_Settings_CM_C::Slider_DialogueVolume' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, Slider_MusicVolume) == 0x000510, "Member 'UWBP_Audio_Settings_CM_C::Slider_MusicVolume' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, Slider_OverallVolume) == 0x000518, "Member 'UWBP_Audio_Settings_CM_C::Slider_OverallVolume' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, Slider_SFXVolume) == 0x000520, "Member 'UWBP_Audio_Settings_CM_C::Slider_SFXVolume' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, VALUI_ScrollBox_Styled_175) == 0x000528, "Member 'UWBP_Audio_Settings_CM_C::VALUI_ScrollBox_Styled_175' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, WBP_Settings_DescriptionBox) == 0x000530, "Member 'UWBP_Audio_Settings_CM_C::WBP_Settings_DescriptionBox' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, AkMusID) == 0x000538, "Member 'UWBP_Audio_Settings_CM_C::AkMusID' has a wrong offset!");
static_assert(offsetof(UWBP_Audio_Settings_CM_C, bIsSynced) == 0x00053C, "Member 'UWBP_Audio_Settings_CM_C::bIsSynced' has a wrong offset!");
