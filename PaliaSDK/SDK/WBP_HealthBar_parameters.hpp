...
{
public:
	class UVitalsComponent*                       Vitals;                                            // 0x0000(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, InstancedReference, ReferenceParm, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class UVitalsComponent*                       K2Node_CustomEvent_Vitals;                         // 0x0008(0x0008)(ConstParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                         Pad_3D97[0x2];                                     // 0x000A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3D98[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_HealthBar_C_Update) == 0x000050, "Wrong size on WBP_HealthBar_C_Update");
...
static_assert(offsetof(WBP_HealthBar_C_Update, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000018, "Member 'WBP_HealthBar_C_Update::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_HealthBar_C_Update, K2Node_Select_Default) == 0x00001C, "Member 'WBP_HealthBar_C_Update::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_HealthBar_C_Update, CallFunc_Conv_IntToFloat_ReturnValue_1) == 0x000020, "Member 'WBP_HealthBar_C_Update::CallFunc_Conv_IntToFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_HealthBar_C_Update, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000028, "Member 'WBP_HealthBar_C_Update::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_HealthBar_C_Update, CallFunc_FClamp_ReturnValue) == 0x000030, "Member 'WBP_HealthBar_C_Update::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_HealthBar_C_Update, CallFunc_Divide_DoubleDouble_A_ImplicitCast) == 0x000038, "Member 'WBP_HealthBar_C_Update::CallFunc_Divide_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_HealthBar_C_Update, CallFunc_Divide_DoubleDouble_B_ImplicitCast) == 0x000040, "Member 'WBP_HealthBar_C_Update::CallFunc_Divide_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_HealthBar_C_Update, CallFunc_SetPercent_InPercent_ImplicitCast) == 0x000048, "Member 'WBP_HealthBar_C_Update::CallFunc_SetPercent_InPercent_ImplicitCast' has a wrong offset!");
