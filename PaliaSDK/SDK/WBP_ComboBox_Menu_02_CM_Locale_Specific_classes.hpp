...
public:
	...
	uint8                                         Pad_4C36[0x3];                                     // 0x0301(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         SelectedSlot;                                      // 0x0304(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          UseScrollbar;                                      // 0x0308(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4C37[0x7];                                     // 0x0309(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C) == 0x000320, "Wrong size on UWBP_ComboBox_Menu_02_CM_Locale_Specific_C");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, UberGraphFrame) == 0x000278, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, Button_Selection) == 0x000280, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::Button_Selection' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, DynamicEntryBox_Options) == 0x000288, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::DynamicEntryBox_Options' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, Image_Backer) == 0x000290, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::Image_Backer' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, Image_DropdownArrow) == 0x000298, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::Image_DropdownArrow' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, Scrollbox_Options) == 0x0002A0, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::Scrollbox_Options' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, SizeBox_OptionsScrollbox) == 0x0002A8, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::SizeBox_OptionsScrollbox' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, TextBlock_CurrentSelection) == 0x0002B0, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::TextBlock_CurrentSelection' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, Options) == 0x0002B8, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::Options' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, OptionWidgetClass) == 0x0002C8, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::OptionWidgetClass' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, OptionsWidgets) == 0x0002D0, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::OptionsWidgets' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, OnOptionSelected) == 0x0002E0, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::OnOptionSelected' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, ButtonStyle) == 0x0002F0, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::ButtonStyle' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, BorderStyle) == 0x0002F8, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::BorderStyle' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, TextJustification) == 0x000300, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::TextJustification' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, SelectedSlot) == 0x000304, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::SelectedSlot' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, UseScrollbar) == 0x000308, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::UseScrollbar' has a wrong offset!");
static_assert(offsetof(UWBP_ComboBox_Menu_02_CM_Locale_Specific_C, SoftOptionWidgets) == 0x000310, "Member 'UWBP_ComboBox_Menu_02_CM_Locale_Specific_C::SoftOptionWidgets' has a wrong offset!");
