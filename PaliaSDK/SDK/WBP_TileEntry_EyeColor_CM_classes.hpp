...
public:
	...
	class UWBP_Template_Button_ColorPicker_01_CM_C* WBP_Button_ColorPicker_CM;                         // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UObject*                                TileItem_EyeColor;                                 // 0x0288(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_TileEntry_EyeColor_CM_C) == 0x000290, "Wrong size on UWBP_TileEntry_EyeColor_CM_C");
static_assert(offsetof(UWBP_TileEntry_EyeColor_CM_C, UberGraphFrame) == 0x000278, "Member 'UWBP_TileEntry_EyeColor_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_TileEntry_EyeColor_CM_C, WBP_Button_ColorPicker_CM) == 0x000280, "Member 'UWBP_TileEntry_EyeColor_CM_C::WBP_Button_ColorPicker_CM' has a wrong offset!");
static_assert(offsetof(UWBP_TileEntry_EyeColor_CM_C, TileItem_EyeColor) == 0x000288, "Member 'UWBP_TileEntry_EyeColor_CM_C::TileItem_EyeColor' has a wrong offset!");
