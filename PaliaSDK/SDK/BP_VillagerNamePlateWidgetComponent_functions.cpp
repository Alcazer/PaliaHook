...
#include "BP_VillagerNamePlateWidgetComponent_classes.hpp"
#include "BP_VillagerNamePlateWidgetComponent_parameters.hpp"
...
void UBP_VillagerNamePlateWidgetComponent_C::ExecuteUbergraph_BP_VillagerNamePlateWidgetComponent(int32 EntryPoint, bool CallFunc_GetIsVisibleToPlayer_IsVisible, bool Temp_bool_Variable, ESlateVisibility Temp_byte_Variable, ESlateVisibility Temp_byte_Variable_1, class AActor* CallFunc_GetOwner_ReturnValue, class AValeriaVillagerCharacter* K2Node_DynamicCast_AsValeria_Villager_Character, bool K2Node_DynamicCast_bSuccess, float K2Node_Event_DeltaSeconds, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue_1, double CallFunc_GetLastDistance_Distance, class UWBP_VillagerNamePlate_C* K2Node_DynamicCast_AsWBP_Villager_Name_Plate, bool K2Node_DynamicCast_bSuccess_1, bool CallFunc_LessEqual_DoubleDouble_ReturnValue, ESlateVisibility K2Node_Select_Default)
{
	...
	Parms.CallFunc_GetLastDistance_Distance = CallFunc_GetLastDistance_Distance;
	Parms.K2Node_DynamicCast_AsWBP_Villager_Name_Plate = K2Node_DynamicCast_AsWBP_Villager_Name_Plate;
...
// Function BP_VillagerNamePlateWidgetComponent.BP_VillagerNamePlateWidgetComponent_C.On Widget Created
// (BlueprintCallable, BlueprintEvent)

void UBP_VillagerNamePlateWidgetComponent_C::On_Widget_Created()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VillagerNamePlateWidgetComponent_C", "On Widget Created");
...
void UBP_VillagerNamePlateWidgetComponent_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VillagerNamePlateWidgetComponent_C", "ReceiveTick");

	Params::BP_VillagerNamePlateWidgetComponent_C_ReceiveTick Parms{};
