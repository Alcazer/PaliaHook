...
public:
	...
	class UWBP_Template_Button_CM_C*              Button_Emoji;                                      // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_TextBlock_Styled*                Emoji_TextBlock;                                   // 0x0288(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 Image_Selected;                                    // 0x0290(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class FText                                   EmojiText;                                         // 0x0298(0x0018)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(UWBP_TIM_ChatTextEmoji_CM_C) == 0x0002B0, "Wrong size on UWBP_TIM_ChatTextEmoji_CM_C");
static_assert(offsetof(UWBP_TIM_ChatTextEmoji_CM_C, UberGraphFrame) == 0x000278, "Member 'UWBP_TIM_ChatTextEmoji_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_TIM_ChatTextEmoji_CM_C, Button_Emoji) == 0x000280, "Member 'UWBP_TIM_ChatTextEmoji_CM_C::Button_Emoji' has a wrong offset!");
static_assert(offsetof(UWBP_TIM_ChatTextEmoji_CM_C, Emoji_TextBlock) == 0x000288, "Member 'UWBP_TIM_ChatTextEmoji_CM_C::Emoji_TextBlock' has a wrong offset!");
static_assert(offsetof(UWBP_TIM_ChatTextEmoji_CM_C, Image_Selected) == 0x000290, "Member 'UWBP_TIM_ChatTextEmoji_CM_C::Image_Selected' has a wrong offset!");
static_assert(offsetof(UWBP_TIM_ChatTextEmoji_CM_C, EmojiText) == 0x000298, "Member 'UWBP_TIM_ChatTextEmoji_CM_C::EmojiText' has a wrong offset!");
