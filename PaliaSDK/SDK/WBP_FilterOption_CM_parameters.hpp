...
public:
	...
	uint8                                         Pad_4C2A[0x1];                                     // 0x0007(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_AkEventGlobal_ReturnValue;                // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4C2B[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_FilterOption_CM_C_OnFocusReceived) == 0x0001B8, "Wrong size on WBP_FilterOption_CM_C_OnFocusReceived");
...
static_assert(offsetof(WBP_FilterOption_CM_C_OnFocusReceived, InFocusEvent) == 0x000040, "Member 'WBP_FilterOption_CM_C_OnFocusReceived::InFocusEvent' has a wrong offset!");
static_assert(offsetof(WBP_FilterOption_CM_C_OnFocusReceived, ReturnValue) == 0x000048, "Member 'WBP_FilterOption_CM_C_OnFocusReceived::ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_FilterOption_CM_C_OnFocusReceived, CallFunc_Handled_ReturnValue) == 0x000100, "Member 'WBP_FilterOption_CM_C_OnFocusReceived::CallFunc_Handled_ReturnValue' has a wrong offset!");
...
public:
	bool                                          IsSelected;                                        // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4C2C[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
