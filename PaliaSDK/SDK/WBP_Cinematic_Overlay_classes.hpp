...
public:
	...
	class UVALUI_TextBlock_Styled*                TextBlock_Subtitles;                               // 0x0530(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Template_Button_Secondary_01_CM_C* WBP_Template_Button_Secondary_01_CM;               // 0x0538(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCV_Cinematic_C*                        Cinematic;                                         // 0x0540(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	double                                        Skip_UI_Visibility_Time;                           // 0x0548(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        Skip_UI_Remaining_Visibility_Time;                 // 0x0550(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CanSkip;                                           // 0x0558(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Cinematic_Overlay_C) == 0x000560, "Wrong size on UWBP_Cinematic_Overlay_C");
static_assert(offsetof(UWBP_Cinematic_Overlay_C, UberGraphFrame) == 0x000528, "Member 'UWBP_Cinematic_Overlay_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Cinematic_Overlay_C, TextBlock_Subtitles) == 0x000530, "Member 'UWBP_Cinematic_Overlay_C::TextBlock_Subtitles' has a wrong offset!");
static_assert(offsetof(UWBP_Cinematic_Overlay_C, WBP_Template_Button_Secondary_01_CM) == 0x000538, "Member 'UWBP_Cinematic_Overlay_C::WBP_Template_Button_Secondary_01_CM' has a wrong offset!");
static_assert(offsetof(UWBP_Cinematic_Overlay_C, Cinematic) == 0x000540, "Member 'UWBP_Cinematic_Overlay_C::Cinematic' has a wrong offset!");
static_assert(offsetof(UWBP_Cinematic_Overlay_C, Skip_UI_Visibility_Time) == 0x000548, "Member 'UWBP_Cinematic_Overlay_C::Skip_UI_Visibility_Time' has a wrong offset!");
static_assert(offsetof(UWBP_Cinematic_Overlay_C, Skip_UI_Remaining_Visibility_Time) == 0x000550, "Member 'UWBP_Cinematic_Overlay_C::Skip_UI_Remaining_Visibility_Time' has a wrong offset!");
static_assert(offsetof(UWBP_Cinematic_Overlay_C, CanSkip) == 0x000558, "Member 'UWBP_Cinematic_Overlay_C::CanSkip' has a wrong offset!");
