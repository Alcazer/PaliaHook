...
static_assert(sizeof(ALocation_VillagerVisit_Temp_C) == 0x0002A8, "Wrong size on ALocation_VillagerVisit_Temp_C");
static_assert(offsetof(ALocation_VillagerVisit_Temp_C, Billboard) == 0x0002A0, "Member 'ALocation_VillagerVisit_Temp_C::Billboard' has a wrong offset!");
