...
public:
	...
	class UBorder*                                Border_Background;                                 // 0x0530(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URichTextBlock*                         RichText_Prompt;                                   // 0x0538(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Template_Popup_01_PF_C*            WBP_Template_Popup_01_PF;                          // 0x0540(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FUniqueNetIdRepl                       TargetUserId;                                      // 0x0548(0x0030)(Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             BlockErrorSent;                                    // 0x0578(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class FText                                   ReportConfirmationText;                            // 0x0588(0x0018)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UClass*                                 Button_Style_Override;                             // 0x05A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UWidget*                                Parent_Widget;                                     // 0x05A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWidget*                                Parent_Focused_Widget;                             // 0x05B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_Block_ModalDialogue_PF_C) == 0x0005B8, "Wrong size on UWBP_Block_ModalDialogue_PF_C");
static_assert(offsetof(UWBP_Block_ModalDialogue_PF_C, UberGraphFrame) == 0x000528, "Member 'UWBP_Block_ModalDialogue_PF_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_PF_C, Border_Background) == 0x000530, "Member 'UWBP_Block_ModalDialogue_PF_C::Border_Background' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_PF_C, RichText_Prompt) == 0x000538, "Member 'UWBP_Block_ModalDialogue_PF_C::RichText_Prompt' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_PF_C, WBP_Template_Popup_01_PF) == 0x000540, "Member 'UWBP_Block_ModalDialogue_PF_C::WBP_Template_Popup_01_PF' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_PF_C, TargetUserId) == 0x000548, "Member 'UWBP_Block_ModalDialogue_PF_C::TargetUserId' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_PF_C, BlockErrorSent) == 0x000578, "Member 'UWBP_Block_ModalDialogue_PF_C::BlockErrorSent' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_PF_C, ReportConfirmationText) == 0x000588, "Member 'UWBP_Block_ModalDialogue_PF_C::ReportConfirmationText' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_PF_C, Button_Style_Override) == 0x0005A0, "Member 'UWBP_Block_ModalDialogue_PF_C::Button_Style_Override' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_PF_C, Parent_Widget) == 0x0005A8, "Member 'UWBP_Block_ModalDialogue_PF_C::Parent_Widget' has a wrong offset!");
static_assert(offsetof(UWBP_Block_ModalDialogue_PF_C, Parent_Focused_Widget) == 0x0005B0, "Member 'UWBP_Block_ModalDialogue_PF_C::Parent_Focused_Widget' has a wrong offset!");
