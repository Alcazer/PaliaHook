...
public:
	...
	class UVALUI_TileView_Styled*                 TileView_Players;                                  // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_NearbyChatPlayerList_C) == 0x000288, "Wrong size on UWBP_NearbyChatPlayerList_C");
static_assert(offsetof(UWBP_NearbyChatPlayerList_C, UberGraphFrame) == 0x000278, "Member 'UWBP_NearbyChatPlayerList_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_NearbyChatPlayerList_C, TileView_Players) == 0x000280, "Member 'UWBP_NearbyChatPlayerList_C::TileView_Players' has a wrong offset!");
