...
public:
	...
	uint8                                         Pad_159A[0x40];                                    // 0x0058(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_159B[0x4B8];                                   // 0x00B8(0x04B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UReplicationGraph) == 0x000570, "Wrong size on UReplicationGraph");
...
static_assert(sizeof(UBasicReplicationGraph) == 0x0005A0, "Wrong size on UBasicReplicationGraph");
static_assert(offsetof(UBasicReplicationGraph, GridNode) == 0x000570, "Member 'UBasicReplicationGraph::GridNode' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, AlwaysRelevantNode) == 0x000578, "Member 'UBasicReplicationGraph::AlwaysRelevantNode' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, AlwaysRelevantForConnectionList) == 0x000580, "Member 'UBasicReplicationGraph::AlwaysRelevantForConnectionList' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, ActorsWithoutNetConnection) == 0x000590, "Member 'UBasicReplicationGraph::ActorsWithoutNetConnection' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_159C[0x18];                                    // 0x0038(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_159D[0x80];                                    // 0x0050(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_159E[0xB8];                                    // 0x0050(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_159F[0x30];                                    // 0x00D0(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_15A0[0x80];                                    // 0x00D0(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_15A1[0x10];                                    // 0x00D0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_15A2[0x40];                                    // 0x00D0(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_15A3[0x210];                                   // 0x0050(0x0210)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_15A4[0x10];                                    // 0x0058(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_15A5[0x10];                                    // 0x00D0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_15A6[0x10];                                    // 0x0060(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_15A7[0x148];                                   // 0x0030(0x0148)(Fixing Size After Last Property [ Dumper-7 ])
	class AReplicationGraphDebugActor*            DebugActor;                                        // 0x0178(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15A8[0x8];                                     // 0x0180(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FLastLocationGatherInfo>        LastGatherLocations;                               // 0x0188(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_15A9[0x58];                                    // 0x0198(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UReplicationGraphNode_TearOff_ForConnection* TearOffNode;                                       // 0x0200(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_15AA[0xD0];                                    // 0x0208(0x00D0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UNetReplicationGraphConnection, DebugActor) == 0x000178, "Member 'UNetReplicationGraphConnection::DebugActor' has a wrong offset!");
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x02A0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x02A8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AReplicationGraphDebugActor) == 0x0002B0, "Wrong size on AReplicationGraphDebugActor");
static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x0002A0, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x0002A8, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");
