...
public:
	...
	class UWBP_Template_PopupSimple_01_CM_C*      ConfirmButton;                                     // 0x0530(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnContinueClicked;                                 // 0x0538(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(UWBP_PhotosensitivityWarning_CM_C) == 0x000548, "Wrong size on UWBP_PhotosensitivityWarning_CM_C");
static_assert(offsetof(UWBP_PhotosensitivityWarning_CM_C, UberGraphFrame) == 0x000528, "Member 'UWBP_PhotosensitivityWarning_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_PhotosensitivityWarning_CM_C, ConfirmButton) == 0x000530, "Member 'UWBP_PhotosensitivityWarning_CM_C::ConfirmButton' has a wrong offset!");
static_assert(offsetof(UWBP_PhotosensitivityWarning_CM_C, OnContinueClicked) == 0x000538, "Member 'UWBP_PhotosensitivityWarning_CM_C::OnContinueClicked' has a wrong offset!");
