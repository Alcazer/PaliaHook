...
void UWBP_RadialMenuWheel_Circular_C::FindSlotAtAngle(double Angle, double Distance, class UNamedSlot** Param_Slot, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, double CallFunc_SlotIndexToAngle_Angle, int32 CallFunc_Add_IntInt_ReturnValue, double K2Node_MathExpression_ReturnValue, class UNamedSlot* CallFunc_Array_Get_Item, bool CallFunc_LessEqual_DoubleDouble_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue, bool CallFunc_LessEqual_DoubleDouble_ReturnValue_1, double CallFunc_LessEqual_DoubleDouble_B_ImplicitCast)
{
	static class UFunction* Func = nullptr;
