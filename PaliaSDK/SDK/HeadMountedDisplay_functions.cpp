...
EXRDeviceConnectionResult UHeadMountedDisplayFunctionLibrary::ConnectRemoteXRDevice(const class FString& IpAddress, int32 BitRate)
{
	static class UFunction* Func = nullptr;
...
TArray<struct FXRDeviceId> UHeadMountedDisplayFunctionLibrary::EnumerateTrackedDevices(class FName SystemId, EXRTrackedDeviceType DeviceType)
{
	static class UFunction* Func = nullptr;
...
bool UHeadMountedDisplayFunctionLibrary::GetCurrentInteractionProfile(EControllerHand Hand, class FString* InteractionProfile)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("HeadMountedDisplayFunctionLibrary", "GetCurrentInteractionProfile");

	Params::HeadMountedDisplayFunctionLibrary_GetCurrentInteractionProfile Parms{};
...
void UHeadMountedDisplayFunctionLibrary::GetTrackingSensorParameters(struct FVector* Origin, struct FRotator* Rotation, float* LeftFOV, float* RightFOV, float* TopFOV, float* BottomFOV, float* Distance, float* NearPlane, float* FarPlane, bool* IsActive, int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TDelegate<void(class FString& OutReason)>InDisconnectedDelegate                                 (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UHeadMountedDisplayFunctionLibrary::SetXRDisconnectDelegate(TDelegate<void(class FString& OutReason)>& InDisconnectedDelegate)
{
	static class UFunction* Func = nullptr;
...
// TDelegate<void(float Value, struct FTimespan& Time)>InDelegate                                             (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UHeadMountedDisplayFunctionLibrary::SetXRTimedInputActionDelegate(class FName& ActionName, TDelegate<void(float Value, struct FTimespan& Time)>& InDelegate)
{
	static class UFunction* Func = nullptr;
