...
public:
	...
	uint8                                         Pad_4A4D[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A4E[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4A4F[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A50[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A51[0x7];                                     // 0x0051(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4A52[0x5];                                     // 0x004B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	TSoftObjectPtr<class UInputAction>            InputAction;                                       // 0x0008(0x0030)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash)
	EInteractEventIndex                           OutEventIndex;                                     // 0x0038(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_Mailbox_C_GetEventIndexForInputAction) == 0x000040, "Wrong size on BP_Mailbox_C_GetEventIndexForInputAction");
...
static_assert(offsetof(BP_Mailbox_C_GetEventIndexForInputAction, OutEventIndex) == 0x000038, "Member 'BP_Mailbox_C_GetEventIndexForInputAction::OutEventIndex' has a wrong offset!");
static_assert(offsetof(BP_Mailbox_C_GetEventIndexForInputAction, ReturnValue) == 0x000039, "Member 'BP_Mailbox_C_GetEventIndexForInputAction::ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4A53[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UInputAction>            ReturnValue;                                       // 0x0010(0x0030)(Parm, OutParm, ReturnParm, UObjectWrapper, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_Mailbox_C_GetInputActionForEventIndex) == 0x000040, "Wrong size on BP_Mailbox_C_GetInputActionForEventIndex");
...
public:
	class AValeriaCharacter*                      Character;                                         // 0x0000(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	EInteractEventIndex                           EventIndex;                                        // 0x0008(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4A54[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A55[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A56[0x7];                                     // 0x0079(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4A57[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInputMappingPriorityData              OutMappingData;                                    // 0x0010(0x0040)(Parm, OutParm)
	struct FModifyContextOptions                  OutOptions;                                        // 0x0050(0x0001)(Parm, OutParm, NoDestructor)
	bool                                          ReturnValue;                                       // 0x0051(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_Mailbox_C_GetUseableIMC) == 0x000008, "Wrong alignment on BP_Mailbox_C_GetUseableIMC");
static_assert(sizeof(BP_Mailbox_C_GetUseableIMC) == 0x000058, "Wrong size on BP_Mailbox_C_GetUseableIMC");
...
static_assert(offsetof(BP_Mailbox_C_GetUseableIMC, OutOptions) == 0x000050, "Member 'BP_Mailbox_C_GetUseableIMC::OutOptions' has a wrong offset!");
static_assert(offsetof(BP_Mailbox_C_GetUseableIMC, ReturnValue) == 0x000051, "Member 'BP_Mailbox_C_GetUseableIMC::ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4A58[0x5];                                     // 0x0023(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class AHousingOwnershipActor*                 CallFunc_GetOccupiedHousingOwnershipActor_ReturnValue; // 0x0028(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x0030(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_Mailbox_C_IsInteractable, K2Node_Select_Default) == 0x00003C, "Member 'BP_Mailbox_C_IsInteractable::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_Mailbox_C_IsInteractable, CallFunc_BooleanOR_ReturnValue) == 0x00003D, "Member 'BP_Mailbox_C_IsInteractable::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
