...
public:
	...
	uint8                                         Pad_3A38[0x6];                                     // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3A39[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3A3A[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3A3B[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3A3C[0x2];                                     // 0x0076(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_ExpandableArea_CM_C_OnFocusReceived) == 0x0001B8, "Wrong size on WBP_ExpandableArea_CM_C_OnFocusReceived");
...
static_assert(offsetof(WBP_ExpandableArea_CM_C_OnFocusReceived, InFocusEvent) == 0x000040, "Member 'WBP_ExpandableArea_CM_C_OnFocusReceived::InFocusEvent' has a wrong offset!");
static_assert(offsetof(WBP_ExpandableArea_CM_C_OnFocusReceived, ReturnValue) == 0x000048, "Member 'WBP_ExpandableArea_CM_C_OnFocusReceived::ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ExpandableArea_CM_C_OnFocusReceived, CallFunc_Handled_ReturnValue) == 0x000100, "Member 'WBP_ExpandableArea_CM_C_OnFocusReceived::CallFunc_Handled_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3A3E[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3A3F[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UAkAudioEvent*                          K2Node_Select_Default;                             // 0x0008(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
