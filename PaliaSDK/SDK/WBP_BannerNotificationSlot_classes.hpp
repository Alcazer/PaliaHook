...
{
public:
	class USizeBox*                               Box_BannerNotification;                            // 0x04F0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVALUI_NotificationQueue*               Notification_Queue;                                // 0x04F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  CurrentNotificationId;                             // 0x0500(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  InputActionHandle_DismissNotification;             // 0x0510(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                           RetryTimer;                                        // 0x0520(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          CanShowNotificationsWithoutValidPlayerCharacter;   // 0x0528(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_BannerNotificationSlot_C) == 0x000530, "Wrong size on UWBP_BannerNotificationSlot_C");
static_assert(offsetof(UWBP_BannerNotificationSlot_C, Box_BannerNotification) == 0x0004F0, "Member 'UWBP_BannerNotificationSlot_C::Box_BannerNotification' has a wrong offset!");
static_assert(offsetof(UWBP_BannerNotificationSlot_C, Notification_Queue) == 0x0004F8, "Member 'UWBP_BannerNotificationSlot_C::Notification_Queue' has a wrong offset!");
static_assert(offsetof(UWBP_BannerNotificationSlot_C, CurrentNotificationId) == 0x000500, "Member 'UWBP_BannerNotificationSlot_C::CurrentNotificationId' has a wrong offset!");
static_assert(offsetof(UWBP_BannerNotificationSlot_C, InputActionHandle_DismissNotification) == 0x000510, "Member 'UWBP_BannerNotificationSlot_C::InputActionHandle_DismissNotification' has a wrong offset!");
static_assert(offsetof(UWBP_BannerNotificationSlot_C, RetryTimer) == 0x000520, "Member 'UWBP_BannerNotificationSlot_C::RetryTimer' has a wrong offset!");
static_assert(offsetof(UWBP_BannerNotificationSlot_C, CanShowNotificationsWithoutValidPlayerCharacter) == 0x000528, "Member 'UWBP_BannerNotificationSlot_C::CanShowNotificationsWithoutValidPlayerCharacter' has a wrong offset!");
