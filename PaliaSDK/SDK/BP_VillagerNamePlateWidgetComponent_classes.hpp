...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_VillagerNamePlateWidgetComponent_C; // 0x0958(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	double                                        DistanceToShowName;                                // 0x0960(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UBP_VillagerNamePlateWidgetComponent_C) == 0x000970, "Wrong size on UBP_VillagerNamePlateWidgetComponent_C");
static_assert(offsetof(UBP_VillagerNamePlateWidgetComponent_C, UberGraphFrame_BP_VillagerNamePlateWidgetComponent_C) == 0x000958, "Member 'UBP_VillagerNamePlateWidgetComponent_C::UberGraphFrame_BP_VillagerNamePlateWidgetComponent_C' has a wrong offset!");
static_assert(offsetof(UBP_VillagerNamePlateWidgetComponent_C, DistanceToShowName) == 0x000960, "Member 'UBP_VillagerNamePlateWidgetComponent_C::DistanceToShowName' has a wrong offset!");
