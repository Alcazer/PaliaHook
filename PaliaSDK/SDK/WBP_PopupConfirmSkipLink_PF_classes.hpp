...
static_assert(sizeof(UWBP_PopupConfirmSkipLink_PF_C) == 0x000558, "Wrong size on UWBP_PopupConfirmSkipLink_PF_C");
static_assert(offsetof(UWBP_PopupConfirmSkipLink_PF_C, UberGraphFrame) == 0x000528, "Member 'UWBP_PopupConfirmSkipLink_PF_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_PopupConfirmSkipLink_PF_C, WBP_Popup_CM) == 0x000530, "Member 'UWBP_PopupConfirmSkipLink_PF_C::WBP_Popup_CM' has a wrong offset!");
static_assert(offsetof(UWBP_PopupConfirmSkipLink_PF_C, OnConfirm) == 0x000538, "Member 'UWBP_PopupConfirmSkipLink_PF_C::OnConfirm' has a wrong offset!");
static_assert(offsetof(UWBP_PopupConfirmSkipLink_PF_C, OnCancel) == 0x000548, "Member 'UWBP_PopupConfirmSkipLink_PF_C::OnCancel' has a wrong offset!");
