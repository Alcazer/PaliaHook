...
public:
	...
	uint8                                         Pad_3A11[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          CallFunc_PlayAudio_Success;                        // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_ShouldPlay_Should;                        // 0x0049(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Ak_OneShot_Base_C_Received_Notify) == 0x000008, "Wrong alignment on Ak_OneShot_Base_C_Received_Notify");
static_assert(sizeof(Ak_OneShot_Base_C_Received_Notify) == 0x000050, "Wrong size on Ak_OneShot_Base_C_Received_Notify");
...
static_assert(offsetof(Ak_OneShot_Base_C_Received_Notify, ReturnValue) == 0x000038, "Member 'Ak_OneShot_Base_C_Received_Notify::ReturnValue' has a wrong offset!");
static_assert(offsetof(Ak_OneShot_Base_C_Received_Notify, AK) == 0x000040, "Member 'Ak_OneShot_Base_C_Received_Notify::AK' has a wrong offset!");
static_assert(offsetof(Ak_OneShot_Base_C_Received_Notify, CallFunc_PlayAudio_Success) == 0x000048, "Member 'Ak_OneShot_Base_C_Received_Notify::CallFunc_PlayAudio_Success' has a wrong offset!");
static_assert(offsetof(Ak_OneShot_Base_C_Received_Notify, CallFunc_ShouldPlay_Should) == 0x000049, "Member 'Ak_OneShot_Base_C_Received_Notify::CallFunc_ShouldPlay_Should' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3A12[0x5];                                     // 0x000B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3A13[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
