...
static_assert(sizeof(BP_ItemDrag_C_DragCancelled) == 0x000098, "Wrong size on BP_ItemDrag_C_DragCancelled");
...
static_assert(sizeof(BP_ItemDrag_C_DragStarted) == 0x000098, "Wrong size on BP_ItemDrag_C_DragStarted");
...
static_assert(sizeof(BP_ItemDrag_C_Drop) == 0x000098, "Wrong size on BP_ItemDrag_C_Drop");
...
static_assert(sizeof(BP_ItemDrag_C_ExecuteUbergraph_BP_ItemDrag) == 0x0001D0, "Wrong size on BP_ItemDrag_C_ExecuteUbergraph_BP_ItemDrag");
...
static_assert(offsetof(BP_ItemDrag_C_ExecuteUbergraph_BP_ItemDrag, K2Node_Event_PointerEvent_1) == 0x0000A0, "Member 'BP_ItemDrag_C_ExecuteUbergraph_BP_ItemDrag::K2Node_Event_PointerEvent_1' has a wrong offset!");
static_assert(offsetof(BP_ItemDrag_C_ExecuteUbergraph_BP_ItemDrag, K2Node_Event_PointerEvent) == 0x000138, "Member 'BP_ItemDrag_C_ExecuteUbergraph_BP_ItemDrag::K2Node_Event_PointerEvent' has a wrong offset!");
...
public:
	...
	struct FValeriaItem                           CallFunc_GetItem_ReturnValue;                      // 0x0038(0x0068)()
	...
	uint8                                         Pad_43B0[0x6];                                     // 0x00B2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_ItemDrag_C_GetItemAudioConfig) == 0x0000F8, "Wrong size on BP_ItemDrag_C_GetItemAudioConfig");
...
static_assert(offsetof(BP_ItemDrag_C_GetItemAudioConfig, CallFunc_LoadAsset_Blocking_ReturnValue) == 0x0000A0, "Member 'BP_ItemDrag_C_GetItemAudioConfig::CallFunc_LoadAsset_Blocking_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ItemDrag_C_GetItemAudioConfig, K2Node_DynamicCast_AsItem_Type_Definition) == 0x0000A8, "Member 'BP_ItemDrag_C_GetItemAudioConfig::K2Node_DynamicCast_AsItem_Type_Definition' has a wrong offset!");
static_assert(offsetof(BP_ItemDrag_C_GetItemAudioConfig, K2Node_DynamicCast_bSuccess) == 0x0000B0, "Member 'BP_ItemDrag_C_GetItemAudioConfig::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_ItemDrag_C_GetItemAudioConfig, CallFunc_IsValid_ReturnValue) == 0x0000B1, "Member 'BP_ItemDrag_C_GetItemAudioConfig::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ItemDrag_C_GetItemAudioConfig, CallFunc_GetDataTableRowFromName_OutRow) == 0x0000B8, "Member 'BP_ItemDrag_C_GetItemAudioConfig::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(BP_ItemDrag_C_GetItemAudioConfig, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x0000F0, "Member 'BP_ItemDrag_C_GetItemAudioConfig::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_43B1[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_43B2[0x4];                                     // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_43B3[0x3];                                     // 0x0085(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_43B4[0x3];                                     // 0x008D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_43B5[0x3];                                     // 0x0095(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
