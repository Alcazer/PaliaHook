...
{
public:
	uint8                                         Pad_2372[0x20];                                    // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_2373[0x50];                                    // 0x0000(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_2374[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_2375[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2376[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_2377[0x4];                                     // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FLevelSequencePlayerSnapshot) == 0x000008, "Wrong alignment on FLevelSequencePlayerSnapshot");
static_assert(sizeof(FLevelSequencePlayerSnapshot) == 0x0000B0, "Wrong size on FLevelSequencePlayerSnapshot");
...
static_assert(offsetof(FLevelSequencePlayerSnapshot, ActiveShot) == 0x0000A0, "Member 'FLevelSequencePlayerSnapshot::ActiveShot' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, ShotID) == 0x0000A8, "Member 'FLevelSequencePlayerSnapshot::ShotID' has a wrong offset!");
