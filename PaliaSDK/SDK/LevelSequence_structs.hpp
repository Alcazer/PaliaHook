...
static_assert(offsetof(FLevelSequenceBindingReference, ObjectPath) == 0x000030, "Member 'FLevelSequenceBindingReference::ObjectPath' has a wrong offset!");
...
{
public:
	uint8                                         Pad_18BB[0x20];                                    // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_18BC[0x50];                                    // 0x0000(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_18BD[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bExportTransforms) == 0x000030, "Member 'FLevelSequenceAnimSequenceLinkItem::bExportTransforms' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bExportMorphTargets) == 0x000031, "Member 'FLevelSequenceAnimSequenceLinkItem::bExportMorphTargets' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bExportAttributeCurves) == 0x000032, "Member 'FLevelSequenceAnimSequenceLinkItem::bExportAttributeCurves' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bExportMaterialCurves) == 0x000033, "Member 'FLevelSequenceAnimSequenceLinkItem::bExportMaterialCurves' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, Interpolation) == 0x000034, "Member 'FLevelSequenceAnimSequenceLinkItem::Interpolation' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, CurveInterpolation) == 0x000035, "Member 'FLevelSequenceAnimSequenceLinkItem::CurveInterpolation' has a wrong offset!");
...
static_assert(offsetof(FLevelSequenceObject, ComponentName) == 0x000018, "Member 'FLevelSequenceObject::ComponentName' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_18BE[0x4];                                     // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FLevelSequencePlayerSnapshot) == 0x0000C8, "Wrong size on FLevelSequencePlayerSnapshot");
static_assert(offsetof(FLevelSequencePlayerSnapshot, RootName) == 0x000000, "Member 'FLevelSequencePlayerSnapshot::RootName' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, RootTime) == 0x000010, "Member 'FLevelSequencePlayerSnapshot::RootTime' has a wrong offset!");
...
static_assert(offsetof(FLevelSequencePlayerSnapshot, MasterName) == 0x0000A8, "Member 'FLevelSequencePlayerSnapshot::MasterName' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, MasterTime) == 0x0000B8, "Member 'FLevelSequencePlayerSnapshot::MasterTime' has a wrong offset!");
