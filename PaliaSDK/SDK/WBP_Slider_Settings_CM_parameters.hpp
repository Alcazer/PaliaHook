...
public:
	...
	uint8                                         Pad_47A2[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FFSettingsItemSlider                   Param_SliderSettings;                              // 0x0000(0x0030)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SetDefaultNotchValue_InValue_ImplicitCast; // 0x0050(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_Slider_Settings_CM_C_SetSliderSettings) == 0x000058, "Wrong size on WBP_Slider_Settings_CM_C_SetSliderSettings");
...
static_assert(offsetof(WBP_Slider_Settings_CM_C_SetSliderSettings, Temp_byte_Variable) == 0x000030, "Member 'WBP_Slider_Settings_CM_C_SetSliderSettings::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Slider_Settings_CM_C_SetSliderSettings, Temp_byte_Variable_1) == 0x000031, "Member 'WBP_Slider_Settings_CM_C_SetSliderSettings::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_Slider_Settings_CM_C_SetSliderSettings, Temp_bool_Variable) == 0x000032, "Member 'WBP_Slider_Settings_CM_C_SetSliderSettings::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Slider_Settings_CM_C_SetSliderSettings, K2Node_Select_Default) == 0x000033, "Member 'WBP_Slider_Settings_CM_C_SetSliderSettings::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_Slider_Settings_CM_C_SetSliderSettings, CallFunc_Conv_DoubleToText_ReturnValue) == 0x000038, "Member 'WBP_Slider_Settings_CM_C_SetSliderSettings::CallFunc_Conv_DoubleToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Slider_Settings_CM_C_SetSliderSettings, CallFunc_SetDefaultNotchValue_InValue_ImplicitCast) == 0x000050, "Member 'WBP_Slider_Settings_CM_C_SetSliderSettings::CallFunc_SetDefaultNotchValue_InValue_ImplicitCast' has a wrong offset!");
