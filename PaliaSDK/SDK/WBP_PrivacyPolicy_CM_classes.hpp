...
public:
	...
	class UCommonVisibilitySwitcher*              CommonVisibilitySwitcher_0;                        // 0x0560(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_PrivacyPolicy_CM_C) == 0x0005B0, "Wrong size on UWBP_PrivacyPolicy_CM_C");
static_assert(offsetof(UWBP_PrivacyPolicy_CM_C, UberGraphFrame) == 0x000558, "Member 'UWBP_PrivacyPolicy_CM_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_PrivacyPolicy_CM_C, CommonVisibilitySwitcher_0) == 0x000560, "Member 'UWBP_PrivacyPolicy_CM_C::CommonVisibilitySwitcher_0' has a wrong offset!");
static_assert(offsetof(UWBP_PrivacyPolicy_CM_C, RichTextBlock_Message) == 0x000568, "Member 'UWBP_PrivacyPolicy_CM_C::RichTextBlock_Message' has a wrong offset!");
static_assert(offsetof(UWBP_PrivacyPolicy_CM_C, Scrollbox_Message) == 0x000570, "Member 'UWBP_PrivacyPolicy_CM_C::Scrollbox_Message' has a wrong offset!");
static_assert(offsetof(UWBP_PrivacyPolicy_CM_C, WBP_CommonUIButtonPrompt) == 0x000578, "Member 'UWBP_PrivacyPolicy_CM_C::WBP_CommonUIButtonPrompt' has a wrong offset!");
static_assert(offsetof(UWBP_PrivacyPolicy_CM_C, WBP_Template_Button_Primary_01_CM) == 0x000580, "Member 'UWBP_PrivacyPolicy_CM_C::WBP_Template_Button_Primary_01_CM' has a wrong offset!");
static_assert(offsetof(UWBP_PrivacyPolicy_CM_C, WBP_Template_PopupSecondary_02_CM) == 0x000588, "Member 'UWBP_PrivacyPolicy_CM_C::WBP_Template_PopupSecondary_02_CM' has a wrong offset!");
static_assert(offsetof(UWBP_PrivacyPolicy_CM_C, WidgetSwitcher_MessageState) == 0x000590, "Member 'UWBP_PrivacyPolicy_CM_C::WidgetSwitcher_MessageState' has a wrong offset!");
static_assert(offsetof(UWBP_PrivacyPolicy_CM_C, OnConfirm) == 0x000598, "Member 'UWBP_PrivacyPolicy_CM_C::OnConfirm' has a wrong offset!");
static_assert(offsetof(UWBP_PrivacyPolicy_CM_C, ScrollScale) == 0x0005A8, "Member 'UWBP_PrivacyPolicy_CM_C::ScrollScale' has a wrong offset!");
