...
public:
	...
	class UImage*                                 Image_QuestStatus;                                 // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class AValeriaVillagerCharacter*              Villager;                                          // 0x0288(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          bWorldVillagerType;                                // 0x0290(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_436E[0x3];                                     // 0x0291(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         ID;                                                // 0x0294(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IdIsVillagerCoreId;                                // 0x0298(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_436F[0x7];                                     // 0x0299(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AValeriaCharacter*                      OwningValeriaCharacter;                            // 0x02A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class UDialogueManagerComponent*              DialogueManagerComponent;                          // 0x02A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	EDialogueTypeCategory                         DialogueTypeCategory;                              // 0x02B0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4370[0x7];                                     // 0x02B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UTrackingComponent*                     TrackingComponent;                                 // 0x02B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_VillagerQuestPlate_C) == 0x0002C0, "Wrong size on UWBP_VillagerQuestPlate_C");
static_assert(offsetof(UWBP_VillagerQuestPlate_C, UberGraphFrame) == 0x000278, "Member 'UWBP_VillagerQuestPlate_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_VillagerQuestPlate_C, Image_QuestStatus) == 0x000280, "Member 'UWBP_VillagerQuestPlate_C::Image_QuestStatus' has a wrong offset!");
static_assert(offsetof(UWBP_VillagerQuestPlate_C, Villager) == 0x000288, "Member 'UWBP_VillagerQuestPlate_C::Villager' has a wrong offset!");
static_assert(offsetof(UWBP_VillagerQuestPlate_C, bWorldVillagerType) == 0x000290, "Member 'UWBP_VillagerQuestPlate_C::bWorldVillagerType' has a wrong offset!");
static_assert(offsetof(UWBP_VillagerQuestPlate_C, ID) == 0x000294, "Member 'UWBP_VillagerQuestPlate_C::ID' has a wrong offset!");
static_assert(offsetof(UWBP_VillagerQuestPlate_C, IdIsVillagerCoreId) == 0x000298, "Member 'UWBP_VillagerQuestPlate_C::IdIsVillagerCoreId' has a wrong offset!");
static_assert(offsetof(UWBP_VillagerQuestPlate_C, OwningValeriaCharacter) == 0x0002A0, "Member 'UWBP_VillagerQuestPlate_C::OwningValeriaCharacter' has a wrong offset!");
static_assert(offsetof(UWBP_VillagerQuestPlate_C, DialogueManagerComponent) == 0x0002A8, "Member 'UWBP_VillagerQuestPlate_C::DialogueManagerComponent' has a wrong offset!");
static_assert(offsetof(UWBP_VillagerQuestPlate_C, DialogueTypeCategory) == 0x0002B0, "Member 'UWBP_VillagerQuestPlate_C::DialogueTypeCategory' has a wrong offset!");
static_assert(offsetof(UWBP_VillagerQuestPlate_C, TrackingComponent) == 0x0002B8, "Member 'UWBP_VillagerQuestPlate_C::TrackingComponent' has a wrong offset!");
